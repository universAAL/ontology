...
public abstract class MDS extends Device {
	...
	public static final String PROP_SYSTEM_ID = X73Ontology.NAMESPACE + "systemId";
	public static final String PROP_SYSTEM_TYPE_SPEC_LIST = X73Ontology.NAMESPACE + "systemTypeSpecList";
	public static final String PROP_SYSTEM_MODEL = X73Ontology.NAMESPACE + "systemModel";
	...
	public boolean isWellFormed() {
		return true && hasProperty(PROP_SYSTEM_ID) && hasProperty(PROP_SYSTEM_TYPE_SPEC_LIST)
