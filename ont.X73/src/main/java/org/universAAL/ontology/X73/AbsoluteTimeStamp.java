...
public class AbsoluteTimeStamp extends ManagedIndividual {
	public static final String MY_URI = X73Ontology.NAMESPACE + "AbsoluteTimeStamp";
	...
	public static final String PROP_SECFRACTIONS = X73Ontology.NAMESPACE + "secfractions";
