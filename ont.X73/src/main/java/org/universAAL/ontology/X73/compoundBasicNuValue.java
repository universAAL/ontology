...
public class compoundBasicNuValue extends ManagedIndividual {
	public static final String MY_URI = X73Ontology.NAMESPACE + "compoundBasicNuValue";
	public static final String PROP_MEASURED_VALUE_18951 = X73Ontology.NAMESPACE + "measuredValue_18951";
	public static final String PROP_MEASURED_VALUE_18950 = X73Ontology.NAMESPACE + "measuredValue_18950";
	public static final String PROP_MEASURED_VALUE_18949 = X73Ontology.NAMESPACE + "measuredValue_18949";
	...
	public boolean isWellFormed() {
		return true && hasProperty(PROP_MEASURED_VALUE_18951) && hasProperty(PROP_MEASURED_VALUE_18950)
