...
public class BloodPressureMonitor extends MDS {
	public static final String MY_URI = X73Ontology.NAMESPACE + "BloodPressureMonitor";
	public static final String PROP_HAS_MEASURED_B_P_SYS = X73Ontology.NAMESPACE + "hasMeasuredBPSys";
	public static final String PROP_HAS_MEASURED_B_P_DIA = X73Ontology.NAMESPACE + "hasMeasuredBPDia";
	public static final String PROP_HAS_MEASURED_PULSE = X73Ontology.NAMESPACE + "hasMeasuredPulse";
	...
	public int getPropSerializationType(String propURI) {
		return PROP_HAS_MEASURED_B_P_SYS.equals(propURI) || PROP_HAS_MEASURED_B_P_DIA.equals(propURI)
				|| PROP_HAS_MEASURED_PULSE.equals(propURI) ? PROP_SERIALIZATION_FULL
						: super.getPropSerializationType(propURI);
	}

	public boolean isWellFormed() {
		return true && hasProperty(PROP_HAS_MEASURED_B_P_SYS) && hasProperty(PROP_HAS_MEASURED_B_P_DIA)
