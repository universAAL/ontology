...
public abstract class MDSAttribute extends ManagedIndividual {
	...
	public static final String PROP_BASIC_NU_OBSERVED_VALUE = X73Ontology.NAMESPACE + "basicNuObservedValue";
	public static final String PROP_COMPOUND_BASIC_NU_OBSERVED_VALUE = X73Ontology.NAMESPACE
			+ "compoundBasicNuObservedValue";
	public static final String PROP_UNIT_CODE = X73Ontology.NAMESPACE + "unitCode";
	public static final String PROP_ABSOLUTE_TIME_STAMP = X73Ontology.NAMESPACE + "absoluteTimeStamp";
	...
	public boolean isWellFormed() {
		return true && hasProperty(PROP_BASIC_NU_OBSERVED_VALUE) && hasProperty(PROP_COMPOUND_BASIC_NU_OBSERVED_VALUE)
				&& hasProperty(PROP_UNIT_CODE) && hasProperty(PROP_ABSOLUTE_TIME_STAMP);
	}
	...
	public void setCompoundBasicNuObservedValue(compoundBasicNuValue newPropValue) {
		if (newPropValue != null)
