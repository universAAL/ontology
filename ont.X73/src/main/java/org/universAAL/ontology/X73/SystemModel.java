...
public class SystemModel extends ManagedIndividual {
	...
	public static final String PROP_MANUFACTURER = X73Ontology.NAMESPACE + "manufacturer";
	public static final String PROP_MODEL_NUMBER = X73Ontology.NAMESPACE + "modelNumber";
	...
	public boolean isWellFormed() {
		return true && hasProperty(PROP_MANUFACTURER) && hasProperty(PROP_MODEL_NUMBER);
	}
