...
public class PowersocketFactory extends ResourceFactoryImpl {
	...
	switch (factoryIndex) {
	case 0:
	    return new Powersocket(instanceURI);
	case 1:
	    return new PowersocketController(instanceURI);
	case 2:
	    return new SwitchableSocket(instanceURI);
	case 3:
	    return new DimmableSocket(instanceURI);
	}
