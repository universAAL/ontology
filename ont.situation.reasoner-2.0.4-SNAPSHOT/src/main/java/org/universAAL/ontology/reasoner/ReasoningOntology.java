...
public final class ReasoningOntology extends Ontology {
	...
	oci_Persistent.addRestriction(MergedRestriction
		.getAllValuesRestrictionWithCardinality(
			Persistent.PROP_PERSISTENT, TypeMapper
	...
	oci_Situation.addRestriction(MergedRestriction
		.getAllValuesRestrictionWithCardinality(
			Situation.PROP_RDF_PREDICATE, TypeMapper
	...
	oci_Situation.addRestriction(MergedRestriction
		.getAllValuesRestrictionWithCardinality(
			Situation.PROP_RDF_SUBJECT, TypeMapper
				.getDatatypeURI(String.class), 1, 1));
	...
	oci_Situation.addRestriction(MergedRestriction
		.getAllValuesRestrictionWithCardinality(
			Situation.PROP_RDF_OBJECT, TypeMapper
				.getDatatypeURI(String.class), 1, 1));
	...
	oci_Query.addRestriction(MergedRestriction
		.getAllValuesRestrictionWithCardinality(
			Query.PROP_FULL_TEXT_QUERY, TypeMapper
	...
	oci_Query.addRestriction(MergedRestriction
		.getAllValuesRestrictionWithCardinality(
			Query.PROP_RESULTING_EVENT, TypeMapper
				.getDatatypeURI(ContextEvent.class), 0, 1));
