...
public class WaterFloodDetector extends Sensor {
    ...
    static {
	MY_URI = Device.uAAL_DEVICE_NAMESPACE + "WaterFloodDetector";
	register(WaterFloodDetector.class);
    }
	...
	return "A Water Flood Detector Device";
    }

    public static String getRDFSLabel() {
	return "Water Flood Detector";
    }
