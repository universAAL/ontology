...
/**
 * Represents the class of physical manufactured things that have some capability. It adds no
 * new property to physical things but just provides means for explicit distinction of
 * certain physical things as devices. 
 * 
 * @author mtazari
 *
 */
public abstract class Device extends PhysicalThing {
	public static final String uAAL_DEVICE_NAMESPACE = uAAL_NAMESPACE_PREFIX + "Device.owl#";
	...
	public static Restriction getClassRestrictionsOnProperty(String propURI) {
		if (PROP_BATTERY_LEVEL.equals(propURI))
			return Restriction.getAllValuesRestrictionWithCardinality(propURI, LevelRating.MY_URI, 1, 0);
