...
public class AlertType extends ManagedIndividual {
	public static final String MY_URI = UIPreferencesProfileOntology.NAMESPACE + "AlertType";

	public static final int VISUAL_ONLY = 0;
	public static final int AUDIO_ONLY = 1;
	public static final int VISUAL_AND_AUDIO = 2;

	private static final String[] names = { "visualOnly", "audioOnly", "visualAndAudio" };
	...
	public static final AlertType visualAndAudio = new AlertType(VISUAL_AND_AUDIO);
