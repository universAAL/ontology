...
public final class UIPreferencesProfileOntology extends Ontology {
	...
	public UIPreferencesProfileOntology() {
		super(NAMESPACE);
		Resource r = getInfo();
		r.setResourceComment("User Interaction preferences of a User based on ETSI ES 746 standard (Personalization and user profile management) and ES 202 642 draft (Personalization of eHealth systems)");
