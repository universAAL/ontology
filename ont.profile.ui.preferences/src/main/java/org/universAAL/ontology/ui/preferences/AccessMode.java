...
public class AccessMode extends Preference {
	public static final String MY_URI = UIPreferencesProfileOntology.NAMESPACE + "AccessMode";
	...
	public static final String PROP_AUDITORY_MODE_STATUS = UIPreferencesProfileOntology.NAMESPACE
			+ "auditoryModeStatus";
	public static final String PROP_VISUAL_MODE_STATUS = UIPreferencesProfileOntology.NAMESPACE + "visualModeStatus";
	public static final String PROP_TEXTUAL_MODE_STATUS = UIPreferencesProfileOntology.NAMESPACE + "textualModeStatus";
	public static final String PROP_TACTILE_MODE_STATUS = UIPreferencesProfileOntology.NAMESPACE + "tactileModeStatus";
	...
	public boolean isWellFormed() {
		return true && hasProperty(PROP_OLFACTORY_MODE_STATUS) && hasProperty(PROP_AUDITORY_MODE_STATUS)
				&& hasProperty(PROP_VISUAL_MODE_STATUS) && hasProperty(PROP_TEXTUAL_MODE_STATUS)
