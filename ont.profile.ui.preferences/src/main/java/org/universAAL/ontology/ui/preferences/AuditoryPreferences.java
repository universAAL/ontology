...
public class AuditoryPreferences extends Preference {
	...
	public static final String MY_URI = UIPreferencesProfileOntology.NAMESPACE + "AuditoryPreferences";

	/** Speech rate */
	public static final String PROP_SPEECH_RATE = UIPreferencesProfileOntology.NAMESPACE + "speechRate";

	/** Gender of a text to speech engine to be used */
	public static final String PROP_VOICE_GENDER = UIPreferencesProfileOntology.NAMESPACE + "voiceGender";

	/** System sounds status (on/off) */
	public static final String PROP_SYSTEM_SOUNDS = UIPreferencesProfileOntology.NAMESPACE + "systemSounds";

	/** Volume intensity */
	public static final String PROP_VOLUME = UIPreferencesProfileOntology.NAMESPACE + "volume";
	 ...
	 */
	public static final String PROP_PITCH = UIPreferencesProfileOntology.NAMESPACE + "pitch";
	...
	public boolean isWellFormed() {
		return true && hasProperty(PROP_SPEECH_RATE) && hasProperty(PROP_VOICE_GENDER)
				&& hasProperty(PROP_SYSTEM_SOUNDS) && hasProperty(PROP_VOLUME) && hasProperty(PROP_PITCH)
