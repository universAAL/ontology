...
public class ColorType extends ManagedIndividual {
	public static final String MY_URI = UIPreferencesProfileOntology.NAMESPACE + "ColorType";
	...
	private static final String[] names = { "white", "black", "lightGray", "darkGrey", "lightBlue", "darkBlue",
			"lightGreen", "darkGreen", "lightRed", "darkRed", "orange", "yellow", "cyan", "purple", "magenta", "pink" };
