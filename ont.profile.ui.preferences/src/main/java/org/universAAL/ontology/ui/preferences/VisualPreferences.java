...
public class VisualPreferences extends Preference {
	public static final String MY_URI = UIPreferencesProfileOntology.NAMESPACE + "VisualPreferences";
	public static final String PROP_BACKGROUND_COLOR = UIPreferencesProfileOntology.NAMESPACE + "backgroundColor";
	public static final String PROP_FLASHING_RESOURCES = UIPreferencesProfileOntology.NAMESPACE + "flashingResources";
	public static final String PROP_DAY_NIGHT_MODE = UIPreferencesProfileOntology.NAMESPACE + "dayNightMode";
	public static final String PROP_HIGHLIGHT_COLOR = UIPreferencesProfileOntology.NAMESPACE + "highlightColor";
	public static final String PROP_WINDOW_LAYOUT = UIPreferencesProfileOntology.NAMESPACE + "windowLayout";
	public static final String PROP_FONT_FAMILY = UIPreferencesProfileOntology.NAMESPACE + "fontFamily";
	public static final String PROP_BRIGHTNESS = UIPreferencesProfileOntology.NAMESPACE + "brightness";
	public static final String PROP_CONTENT_CONTRAST = UIPreferencesProfileOntology.NAMESPACE + "contentContrast";
	public static final String PROP_SCREEN_RESOLUTION = UIPreferencesProfileOntology.NAMESPACE + "screenResolution";
	public static final String PROP_CURSOR_SIZE = UIPreferencesProfileOntology.NAMESPACE + "cursorSize";
	public static final String PROP_SCREEN_SAVER_USAGE = UIPreferencesProfileOntology.NAMESPACE + "screenSaverUsage";
	public static final String PROP_FONT_COLOR = UIPreferencesProfileOntology.NAMESPACE + "fontColor";
	public static final String PROP_FONT_SIZE = UIPreferencesProfileOntology.NAMESPACE + "fontSize";
	public static final String PROP_COMPONENT_SPACING = UIPreferencesProfileOntology.NAMESPACE + "componentSpacing";
	...
	public boolean isWellFormed() {
		return true && hasProperty(PROP_BACKGROUND_COLOR) && hasProperty(PROP_FLASHING_RESOURCES)
				&& hasProperty(PROP_DAY_NIGHT_MODE) && hasProperty(PROP_HIGHLIGHT_COLOR)
				&& hasProperty(PROP_WINDOW_LAYOUT) && hasProperty(PROP_FONT_FAMILY) && hasProperty(PROP_BRIGHTNESS)
				&& hasProperty(PROP_CONTENT_CONTRAST) && hasProperty(PROP_SCREEN_RESOLUTION)
				&& hasProperty(PROP_CURSOR_SIZE) && hasProperty(PROP_SCREEN_SAVER_USAGE) && hasProperty(PROP_FONT_COLOR)
				&& hasProperty(PROP_FONT_SIZE) && hasProperty(PROP_COMPONENT_SPACING);
	}
