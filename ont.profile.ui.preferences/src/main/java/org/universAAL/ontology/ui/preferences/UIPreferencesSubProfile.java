...
public class UIPreferencesSubProfile extends SubProfile {
	public static final String MY_URI = UIPreferencesProfileOntology.NAMESPACE + "UIPreferencesSubProfile";
	public static final String PROP_INTERACTION_PREFERENCES = UIPreferencesProfileOntology.NAMESPACE
			+ "interactionPreferences";
	public static final String PROP_VISUAL_PREFERENCES = UIPreferencesProfileOntology.NAMESPACE + "visualPreferences";
	public static final String PROP_SYSTEM_MENU_PREFERENCES = UIPreferencesProfileOntology.NAMESPACE
			+ "systemMenuPreferences";
	public static final String PROP_ALERT_PREFERENCES = UIPreferencesProfileOntology.NAMESPACE + "alertPreferences";
	public static final String PROP_ACCESS_MODE = UIPreferencesProfileOntology.NAMESPACE + "accessMode";
	public static final String PROP_AUDIO_PREFERENCES = UIPreferencesProfileOntology.NAMESPACE + "audioPreferences";
	...
	public boolean isWellFormed() {
		return true && hasProperty(PROP_INTERACTION_PREFERENCES) && hasProperty(PROP_VISUAL_PREFERENCES)
				&& hasProperty(PROP_SYSTEM_MENU_PREFERENCES) && hasProperty(PROP_ALERT_PREFERENCES)
				&& hasProperty(PROP_ACCESS_MODE) && hasProperty(PROP_AUDIO_PREFERENCES);
	}
