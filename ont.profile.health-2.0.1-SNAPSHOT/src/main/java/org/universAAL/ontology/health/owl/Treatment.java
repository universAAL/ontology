...
public abstract class Treatment extends ManagedIndividual {
    ...
    public static final String PROP_COMPLETENESS = HealthProfileOntology.NAMESPACE
	    + "completeness";
    public static final String PROP_STATUS = HealthProfileOntology.NAMESPACE
	    + "status";

    public static final String PROP_HAS_TREATMENT_PLANNING = HealthProfileOntology.NAMESPACE
	    + "hasTreatmentPlanning";
    public static final String PROP_IS_PRESCRIBED_BY_CAREGIVER = HealthProfileOntology.NAMESPACE
	    + "hasCaregiver";
    public static final String PROP_MOTIVATIONAL_STATUS = HealthProfileOntology.NAMESPACE
	    + "motivationalStatus";
    public static final String PROP_HAS_PRIVACY = HealthProfileOntology.NAMESPACE
	    + "hasPrivacy";
    ...
    public Treatment(AssistedPersonProfile assistedPerson, Caregiver caregiver,
    ...
    public Treatment(String tname, String description, TreatmentPlanning tp,
	    String diseaseURI) {
	// super(assistedPerson + "." + name);
	this.setName(tname);
	this.setCompleteness(0);
	...
	if (propList instanceof List)
	    return (PerformedSession[]) ((List) propList)
		    .toArray(new PerformedSession[0]);
	else if (propList != null)
     ...
     * @return void
     */
    public void inicializateTP(XMLGregorianCalendar stDt,
	    XMLGregorianCalendar endDt) {
