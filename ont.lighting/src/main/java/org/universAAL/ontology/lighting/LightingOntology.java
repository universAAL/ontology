...
public final class LightingOntology extends Ontology {
	...
	public void create() {
		...
		oci.setResourceComment("The class of services controling light sources");
		...
		oci.setResourceComment("The class of services controling blinkable beaming sources");
