...
public class LightSource extends Device {
	...
	public static final String PROP_SOURCE_COLOR = LightingOntology.NAMESPACE + "srcColor";
	...
	public int getPropSerializationType(String propURI) {
		return (PROP_AMBIENT_COVERAGE.equals(propURI) || PROP_PHYSICAL_LOCATION // PROP_SOURCE_LOCATION
				.equals(propURI)) ? PROP_SERIALIZATION_REDUCED : PROP_SERIALIZATION_FULL;
	}
	...
	public boolean isWellFormed() {
		return props.containsKey(PROP_HAS_TYPE) && props.containsKey(PROP_SOURCE_BRIGHTNESS)
