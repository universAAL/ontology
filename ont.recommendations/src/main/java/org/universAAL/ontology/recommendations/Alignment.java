 ...
 */
public abstract class Alignment extends VisualRecommendation {
	public static final String MY_URI = RecommendationsOntology.NAMESPACE + "Alignment";

	public Alignment() {
		super();
	}

	public Alignment(String uri) {
		super(uri);
	}
