 ...
 * f.addAppearanceRecommendation(new HorizontalLayout());
 * </code>
 * </pre>
 * 
...
public class HorizontalLayout extends Layout {
	public static final String MY_URI = RecommendationsOntology.NAMESPACE + "HorizontalLayout";

	public HorizontalLayout() {
		super();
	}

	public HorizontalLayout(String uri) {
		super(uri);
	}
