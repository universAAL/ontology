...
/**
 * Ontological representation of Size in the recommendations ontology. Methods
 ...
 *
 * Definition of Sizes. This is an Abstract Class use subclasses to express more
...
public abstract class Size extends VisualRecommendation {
	public static final String MY_URI = RecommendationsOntology.NAMESPACE + "Size";
	public static final String PROP_HORIZONTAL = RecommendationsOntology.NAMESPACE + "horizontal";
	public static final String PROP_VERTICAL = RecommendationsOntology.NAMESPACE + "vertical";
	public static final String PROP_SIZE_UNIT = RecommendationsOntology.NAMESPACE + "unit";
	...
	public boolean isWellFormed() {
		return super.isWellFormed() && hasProperty(PROP_HORIZONTAL) && hasProperty(PROP_VERTICAL)
