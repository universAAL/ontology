 ...
 * 
 * Used as a placeholder for future extensions. Languaje should be expressed in
 * MIME types (eg: text/css). The content property will contain the body of the
 * script. As all recommendations not all handlers may understand and or apply
...
public abstract class ScriptedRecommendation extends Recommendation {
	public static final String MY_URI = RecommendationsOntology.NAMESPACE + "ScriptRecommendation";
	public static final String PROP_LANGUAJE = RecommendationsOntology.NAMESPACE + "languaje";
	public static final String PROP_CONTENT = RecommendationsOntology.NAMESPACE + "content";
