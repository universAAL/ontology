 ...
 */
public class WebRecommendation extends Recommendations {
  public static final String MY_URI = RecommendationsOntology.NAMESPACE
    + "WebRecommendation";
  public static final String PROP_FAKE = RecommendationsOntology.NAMESPACE
    + "fake";
  ...
  public WebRecommendation (String uri) {
    super(uri);
  }
  ...
  public boolean isWellFormed() {
	return super.isWellFormed() 
      && hasProperty(PROP_FAKE);
  }

  public int getFake() {
	Integer i = (Integer) getProperty(PROP_FAKE);
	return (i == null) ? 0 : i.intValue();
  }		

  public void setFake(int newPropValue) {
      changeProperty(PROP_FAKE, new Integer(newPropValue));
  }		
