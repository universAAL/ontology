...
public class GridLayout extends Layout {
	public static final String MY_URI = RecommendationsOntology.NAMESPACE + "GridLayout";
	...
	public int getPropSerializationType(String propURI) {
		...
		if (propURI.equals(PROP_NUMBER_OF_COLUMNS) || propURI.equals(PROP_NUMBER_OF_ROWS)) {
