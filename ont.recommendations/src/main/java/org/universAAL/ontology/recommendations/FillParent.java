...
/**
 * Ontological representation of FillParent in the recommendations ontology.
 ...
 */
public class FillParent extends VisualRecommendation {
	public static final String MY_URI = RecommendationsOntology.NAMESPACE
			+ "FillParent";

	public static final String PROP_VISUAL_RECOMMENDATION = RecommendationsOntology.NAMESPACE
