 ...
 *
 * A Generic Class for all Visual modality Recommendations supported by
 * universAAL, not all universAAL handlers are supposed to follow (or understand)
...
public abstract class VisualRecommendation extends Recommendation {
	public static final String MY_URI = RecommendationsOntology.NAMESPACE + "VisualRecommendation";
	public static final String PROP_DATA = RecommendationsOntology.NAMESPACE + "data";
