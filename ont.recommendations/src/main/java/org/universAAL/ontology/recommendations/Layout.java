...
/**
 * Ontological representation of Layout in the recommendations ontology. Methods
 ...
 */
public abstract class Layout extends VisualRecommendation {
	public static final String MY_URI = RecommendationsOntology.NAMESPACE + "Layout";

	public Layout() {
		super();
	}

	public Layout(String uri) {
		super(uri);
	}
