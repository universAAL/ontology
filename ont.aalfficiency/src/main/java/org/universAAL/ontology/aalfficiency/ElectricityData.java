...
public class ElectricityData extends ManagedIndividual{
	 public static final String MY_URI;
	  ...
	  static {
		...
		// case.
		PROP_HAS_TODAY_SCORE = AalfficiencyOntology.NAMESPACE +"ElectricityTodayScore";
		PROP_HAS_TOTAL_SCORE = AalfficiencyOntology.NAMESPACE+"ElectricityTotalScore";
		PROP_HAS_SAVING = AalfficiencyOntology.NAMESPACE+"ElectricitySteps";
		PROP_HAS_CHALLENGE = AalfficiencyOntology.NAMESPACE+"ElectricityChallenge";
