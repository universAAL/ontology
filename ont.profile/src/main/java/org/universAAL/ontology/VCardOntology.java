...
public class VCardOntology extends Ontology {
    ...
    protected static final int TEL = 1;
    protected static final int EMAIL = 2;
    protected static final int BBSCOMM = 3;
    protected static final int CAR = 4;
    protected static final int CELL = 5;
    protected static final int FAX = 6;
    protected static final int ISDNCOMM = 7;
    protected static final int MODEM = 8;
    protected static final int MSG = 9;
    protected static final int PAGER = 10;
    protected static final int PCSCOMM = 11;
    protected static final int VIDEO = 12;
    protected static final int VOICE = 13;
    protected static final int INET = 14;
    protected static final int X400MAIL = 15;
    protected static final int NAME = 16;
    protected static final int ORG = 17;
    protected static final int VCARD = 18;
