...
public class PersonalInformationSubprofile extends SubProfile {
    ...
    public static final String PROP_VCARD_VERSION = ProfileOntology.NAMESPACE
	    + "vCardVersion";
    public static final String PROP_LAST_REVISION = ProfileOntology.NAMESPACE
	    + "lastRevision";
    public static final String PROP_NICKNAME = ProfileOntology.NAMESPACE
	    + "nicname";
    public static final String PROP_DISPLAY_NAME = ProfileOntology.NAMESPACE
	    + "displayName";
    public static final String PROP_UCI_LABEL = ProfileOntology.NAMESPACE
	    + "uciLable";
    public static final String PROP_UCI_ADDITIONAL_DATA = ProfileOntology.NAMESPACE
	    + "uciAdditionalData";
    public static final String PROP_BIRTHPLACE = ProfileOntology.NAMESPACE
	    + "birthplace";
    public static final String PROP_ABOUT_ME = ProfileOntology.NAMESPACE
	    + "aboutMe";
    public static final String PROP_GENDER = ProfileOntology.NAMESPACE
	    + "hasGender";
    // From VCard
