...
public class HandGestureType extends ManagedIndividual {
	public static final String MY_URI = HandgesturesOntology.NAMESPACE + "HandGestureType";
	...
	private static final String[] names = { "rightHandSwipeRight", "rightHandSwipeLeft", "leftHandSwipeRight",
			"leftHandSwipeLeft", "twoHandsZoomIn", "twoHandsZoomOut", "rightHandWave", "leftHandWave",
			"rightHandPullDown", "rightHandPushUp", "leftHandPullDown", "leftHandPushUp", "bothHandsPullDown",
			"bothHandsPushUp" };

	public static final HandGestureType rightHandSwipeRight = new HandGestureType(RIGHT_HAND_SWIPE_RIGHT);
	public static final HandGestureType rightHandSwipeLeft = new HandGestureType(RIGHT_HAND_SWIPE_LEFT);
	public static final HandGestureType leftHandSwipeRight = new HandGestureType(LEFT_HAND_SWIPE_RIGHT);
	public static final HandGestureType leftHandSwipeLeft = new HandGestureType(LEFT_HAND_SWIPE_LEFT);
	public static final HandGestureType twoHandsZoomIn = new HandGestureType(TWO_HANDS_ZOOM_IN);
	public static final HandGestureType twoHandsZoomOut = new HandGestureType(TWO_HANDS_ZOOM_OUT);
	public static final HandGestureType rightHandWave = new HandGestureType(RIGHT_HAND_WAVE);
	public static final HandGestureType leftHandWave = new HandGestureType(LEFT_HAND_WAVE);
	public static final HandGestureType rightHandPullDown = new HandGestureType(RIGHT_HAND_PULL_DOWN);
	public static final HandGestureType rightHandPushUp = new HandGestureType(RIGHT_HAND_PUSH_UP);
	public static final HandGestureType leftHandPullDown = new HandGestureType(LEFT_HAND_PULL_DOWN);
	public static final HandGestureType leftHandPushUp = new HandGestureType(LEFT_HAND_PUSH_UP);
	public static final HandGestureType bothHandsPullDown = new HandGestureType(BOTH_HANDS_PULL_DOWN);
	public static final HandGestureType bothHandsPushUp = new HandGestureType(BOTH_HANDS_PUSH_UP);
