...
public class PerformedSession extends ManagedIndividual {
    ...
    public static final String PROP_START_TIME = HealthProfileOntology.NAMESPACE
	    + "sessionStartTime";
    public static final String PROP_END_TIME = HealthProfileOntology.NAMESPACE
	    + "sessionEndTime";

    public static final String PROP_IS_VALID = HealthProfileOntology.NAMESPACE
	    + "isValid";

    public static final String PROP_HAS_ASSOCIATED_TREATMENT = HealthProfileOntology.NAMESPACE
	    + "associatedTreatment";
    ...
    public PerformedSession(Treatment t, XMLGregorianCalendar stTime,
	    XMLGregorianCalendar endTime, boolean isValid) {
