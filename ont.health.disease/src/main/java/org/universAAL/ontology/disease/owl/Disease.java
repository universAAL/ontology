...
public class Disease extends ManagedIndividual {
	...
	public static final String PROP_SYMPTHOMS = DiseaseOntology.NAMESPACE + "sympthoms";
	public static final String PROP_DISEASE_STATUS = DiseaseOntology.NAMESPACE + "diseaseStatus";
	public static final String PROP_ETIOLOGY = DiseaseOntology.NAMESPACE + "etiology";
	public static final String PROP_PATOGENY = DiseaseOntology.NAMESPACE + "patogeny";
	public static final String PROP_EPIDEMIOLOGY = DiseaseOntology.NAMESPACE + "epidemiology";
	public static final String PROP_CONTAGIOUS = DiseaseOntology.NAMESPACE + "contagious";
	public static final String PROP_DIAGNOSTIC = DiseaseOntology.NAMESPACE + "diagnostic";
	public static final String PROP_PRONOSTIC = DiseaseOntology.NAMESPACE + "pronostic";
	...
	public boolean isWellFormed() {
		return true && props.containsKey(PROP_NAME) && props.containsKey(PROP_SYMPTHOMS)
				&& props.containsKey(PROP_DISEASE_STATUS) && props.containsKey(PROP_ETIOLOGY)
				&& props.containsKey(PROP_PATOGENY) && props.containsKey(PROP_EPIDEMIOLOGY)
				&& props.containsKey(PROP_CONTAGIOUS) && props.containsKey(PROP_DIAGNOSTIC)
