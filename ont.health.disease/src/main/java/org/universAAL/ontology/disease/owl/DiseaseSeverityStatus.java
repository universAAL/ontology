...
public class DiseaseSeverityStatus extends ManagedIndividual {
	...
	public static final String MY_URI = DiseaseOntology.NAMESPACE + "DiseaseSeverityStatus";
	...
	public boolean equals(Object other) {
		return other instanceof DiseaseSeverityStatus && ((DiseaseSeverityStatus) other).order == order;
	}
