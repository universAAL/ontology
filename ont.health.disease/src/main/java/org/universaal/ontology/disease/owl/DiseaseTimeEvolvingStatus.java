...
public class DiseaseTimeEvolvingStatus extends ManagedIndividual {
    ...
    public static final DiseaseTimeEvolvingStatus acute = new DiseaseTimeEvolvingStatus(
	    ACUTE);
    public static final DiseaseTimeEvolvingStatus chronic = new DiseaseTimeEvolvingStatus(
	    CHRONIC);
    ...
    public static DiseaseTimeEvolvingStatus getTimeEvolvingStatusTypeByOrder(
	    int order) {
	switch (order) {
	case ACUTE:
	    return acute;
