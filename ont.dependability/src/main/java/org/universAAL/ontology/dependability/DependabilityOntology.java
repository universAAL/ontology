...
public final class DependabilityOntology extends Ontology {
  ...
  public void create() {
    ...
    oci_Symptom.addRestriction(MergedRestriction
      .getAllValuesRestrictionWithCardinality(Symptom.PROP_ERROR_DETECTOR, 
    ...
    oci_ErrorDetector.addRestriction(MergedRestriction
      .getAllValuesRestrictionWithCardinality(ErrorDetector.PROP_FAULT, 
      Fault.MY_URI, 1, 1));
    
    oci_ErrorDetector.addObjectProperty(ErrorDetector.PROP_SYMPTOM).setFunctional();
    oci_ErrorDetector.addRestriction(MergedRestriction
      .getAllValuesRestrictionWithCardinality(ErrorDetector.PROP_SYMPTOM, 
      Symptom.MY_URI, 1, 1));
    ...
    oci_Fault.addRestriction(MergedRestriction
      .getAllValuesRestrictionWithCardinality(Fault.PROP_FAULT_DECISION, 
    ...
    oci_TimingFault.addRestriction(MergedRestriction
      .getAllValuesRestrictionWithCardinality(TimingFault.PROP_TIME_THRESHOLD, 
      TypeMapper.getDatatypeURI(Double.class), 1, 1));
