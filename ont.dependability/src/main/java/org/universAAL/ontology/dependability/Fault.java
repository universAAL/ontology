...
public class Fault extends ManagedIndividual {
	public static final String MY_URI = DependabilityOntology.NAMESPACE + "Fault";
	public static final String PROP_LOCATION = DependabilityOntology.NAMESPACE + "location";
	public static final String PROP_FAULT_DECISION = DependabilityOntology.NAMESPACE + "faultDecision";
	public static final String PROP_TIMESTAMP = DependabilityOntology.NAMESPACE + "timestamp";
	...
	public boolean isWellFormed() {
		return true && hasProperty(PROP_LOCATION) && hasProperty(PROP_FAULT_DECISION) && hasProperty(PROP_TIMESTAMP);
	}
