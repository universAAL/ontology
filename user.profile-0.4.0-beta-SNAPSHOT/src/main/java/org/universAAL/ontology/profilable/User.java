...
public class User extends PhysicalThing implements ProfilableEntity {
	...
	static {
	    	register(ProfilableEntity.class);//This is because of ProfilableEntity. Only once.
		register(User.class);
    }
    ...
    public static Restriction getClassRestrictionsOnProperty(String propURI) {
		if (PROP_HAS_PROFILE.equals(propURI))
			return Restriction.getAllValuesRestrictionWithCardinality(propURI,
				 UserProfile.MY_URI, 1, 0);//This is because of ProfilableEntity
