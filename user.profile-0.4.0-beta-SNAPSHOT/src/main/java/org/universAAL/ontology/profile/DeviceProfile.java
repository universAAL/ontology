...
public class DeviceProfile extends Profile {
	...
	/** Class URI */
	public static final String MY_URI = "http://ontology.universAAL.org/Profile.owl#Device-Profile";
	
	
	static {
		register(DeviceProfile.class);
    }
    ...
    public DeviceProfile(String uri) {
		super(uri);
    }

    protected DeviceProfile(String uriPrefix, int numProps) {
