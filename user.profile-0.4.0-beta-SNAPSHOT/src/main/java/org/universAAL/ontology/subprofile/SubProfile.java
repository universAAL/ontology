...
public class SubProfile extends ManagedIndividual {
	...
	/** Class URI */
	public static final String MY_URI = "http://ontology.universAAL.org/Profile.owl#SubProfile";
	
	
	static {
		register(SubProfile.class);
    }
    ...
    protected SubProfile(String uriPrefix, int numProps) {
