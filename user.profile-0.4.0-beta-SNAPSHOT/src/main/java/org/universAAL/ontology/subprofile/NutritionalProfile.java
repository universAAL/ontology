...
public class NutritionalProfile extends SubProfile {

	/** Class URI */
	public static final String MY_URI = "http://ontology.universAAL.org/Profile.owl#NutritionalProfile";
	
	
	static {
		register(NutritionalProfile.class);
    }
    ...
    public NutritionalProfile(String uri) {
		super(uri);
    }

    protected NutritionalProfile(String uriPrefix, int numProps) {
