...
public class PersonalPreferenceProfile extends SubProfile {

	/** Class URI */
	public static final String MY_URI = "http://ontology.universAAL.org/Profile.owl#PersonalPreferenceProfile";
    ...
    public static String getRDFSLabel() {
		return "PersonalPreferenceProfile";
    }
    
    protected PersonalPreferenceProfile() {
		super();
    }
    ...
    protected PersonalPreferenceProfile(String uriPrefix, int numProps) {
