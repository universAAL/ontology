...
public class MedicationProfile extends SubProfile {

	/** Class URI */
	public static final String MY_URI = "http://ontology.universAAL.org/Profile.owl#MedicationProfile";
	
	
	static {
		register(MedicationProfile.class);
    }
    ...
    public MedicationProfile(String uri) {
		super(uri);
    }

    protected MedicationProfile(String uriPrefix, int numProps) {
