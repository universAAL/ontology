...
public class SleepingState extends ManagedIndividual implements EnumProperty {
	...
	private static final String[] names = {
        "unknown", "asleep", "awake", "prepared_to_sleep", "sleepy"
    };
	...
	public static final SleepingState preparedToSleep = new SleepingState(PREPARED_TO_SLEEP);
	...
	public static ManagedIndividual[] getEnumerationMembers() {
		return new ManagedIndividual[] {
				unknown, asleep, awake, preparedToSleep, sleepy
			};
	}
	...
	public static ManagedIndividual getIndividualByURI(String instanceURI) {
		return (instanceURI != null
				&&  instanceURI.startsWith(USER_STATE_NAMESPACE))?
						valueOf(instanceURI.substring(USER_STATE_NAMESPACE.length()))
						: null;
	}
	...
	public static SleepingState getSleepingStateByOrder(int order) {
        ...
        case PREPARED_TO_SLEEP: return preparedToSleep;
	...
	public List getAllValues() {
		...
		for (int i = 0; i < names.length; ++i) {
			l.add(new Object[]{names[i], SleepingState.getSleepingStateByOrder(i)});
		}
		return l;
	}
}
