...
public class PersonalPreferenceProfile extends ManagedIndividual implements PropertyPublisher {
	...
	static {
		...
		PROP_D_PRIVACY_LEVELS_MAPPED_TO_INSENSIBLE = PROFILING_NAMESPACE + "dPrivacyLevelToInsensible";
		PROP_D_PRIVACY_LEVELS_MAPPED_TO_PERSONAL = PROFILING_NAMESPACE + "dPrivacyLevelToPersonal";
		PROP_D_INTERACTION_MODALITY = PROFILING_NAMESPACE + "dInteractionModality";
		PROP_D_INSENSIBLE_VOLUME_LEVEL = PROFILING_NAMESPACE + "dInsensibleVolumeLevel";
		PROP_D_PERSONAL_VOLUME_LEVEL = PROFILING_NAMESPACE + "dPersonalVolumeLevel";
		PROP_D_INSENSIBLE_MAX_RESOLUTION_X = PROFILING_NAMESPACE + "dInsensibleMaxResolutionX";
		PROP_D_INSENSIBLE_MAX_RESOLUTION_Y = PROFILING_NAMESPACE + "dInsensibleMaxResolutionY";
		PROP_D_PERSONAL_MIN_RESOLUTION_X = PROFILING_NAMESPACE + "dPersonalMinResolutionX";
		PROP_D_PERSONAL_MIN_RESOLUTION_Y = PROFILING_NAMESPACE + "dPersonalMaxResolutionX";
		register(PersonalPreferenceProfile.class);
	}
	
	public static Restriction getClassRestrictionsOnProperty(String propURI) {
		if (PROP_D_VOICE_GENDER.equals(propURI))
			return Restriction.getAllValuesRestrictionWithCardinality(propURI, Gender.MY_URI, 1, 1);
		if (PROP_D_PRIVACY_LEVELS_MAPPED_TO_INSENSIBLE.equals(propURI))
			return Restriction.getAllValuesRestrictionWithCardinality(propURI, PrivacyLevel.MY_URI, 0, 1);
		if (PROP_D_PRIVACY_LEVELS_MAPPED_TO_PERSONAL.equals(propURI))
			return Restriction.getAllValuesRestrictionWithCardinality(propURI, PrivacyLevel.MY_URI, 0, 1);
		if (PROP_D_INTERACTION_MODALITY.equals(propURI))
			return Restriction.getAllValuesRestrictionWithCardinality(propURI, Modality.MY_URI, 1, 1);
	...
	public void setProperty(String propURI, Object o) {
		...
		else if (PROP_D_PRIVACY_LEVELS_MAPPED_TO_INSENSIBLE.equals(propURI)  &&  o instanceof PrivacyLevel[])
			setPLsMappedToInsensible((PrivacyLevel[]) o);
		else if (PROP_D_PRIVACY_LEVELS_MAPPED_TO_PERSONAL.equals(propURI)  &&  o instanceof PrivacyLevel[])
			setPLsMappedToPersonal((PrivacyLevel[]) o);
		else if (PROP_D_INTERACTION_MODALITY.equals(propURI)  &&  o instanceof Modality)
			setXactionModality((Modality)o);
		else if (PROP_D_INSENSIBLE_VOLUME_LEVEL.equals(propURI)  &&  o instanceof Integer)
			setInsensibleVolumeLevel((Integer)o);
		else if (PROP_D_PERSONAL_VOLUME_LEVEL.equals(propURI)  &&  o instanceof Integer)
			setPersonalVolumeLevel((Integer)o);
		else if (PROP_D_INSENSIBLE_MAX_RESOLUTION_X.equals(propURI)  &&  o instanceof Integer)
			setInsensibleMaxX((Integer)o);
		else if (PROP_D_INSENSIBLE_MAX_RESOLUTION_Y.equals(propURI)  &&  o instanceof Integer)
			setInsensibleMaxY((Integer)o);
		else if (PROP_D_PERSONAL_MIN_RESOLUTION_X.equals(propURI)  &&  o instanceof Integer)
			setPersonalMinX((Integer)o);
		else if (PROP_D_PERSONAL_MIN_RESOLUTION_Y.equals(propURI)  &&  o instanceof Integer)
	...
	public static String[] getStandardPropertyURIs() {
		return new String[] {
				PROP_D_PRIVACY_LEVELS_MAPPED_TO_INSENSIBLE,
				PROP_D_PRIVACY_LEVELS_MAPPED_TO_PERSONAL,
				PROP_D_INTERACTION_MODALITY,
				PROP_D_VOICE_GENDER,
				PROP_D_INSENSIBLE_VOLUME_LEVEL,
				PROP_D_PERSONAL_VOLUME_LEVEL,
	...
	public ProfileProperty[] getDynamicProperties() {
		...
		ppArray[0] = new ProfileProperty(
				(getVoiceGender() == null ? Gender.male : getVoiceGender()), PROP_D_VOICE_GENDER, "Voice Gender", false);
		ppArray[1] = new ProfileProperty(
				((getPLsMappedToInsensible() == null) ? new PrivacyLevel[0] : getPLsMappedToInsensible()), PROP_D_PRIVACY_LEVELS_MAPPED_TO_INSENSIBLE, "Privacy level", false);
		ppArray[2] = new ProfileProperty(
				((getPLsMappedToPersonal() == null) ? new PrivacyLevel[0] : getPLsMappedToPersonal()), PROP_D_INTERACTION_MODALITY, "Interaction modality", false);
		ppArray[3] = new ProfileProperty((getInsensibleVolumeLevel()), PROP_D_INSENSIBLE_VOLUME_LEVEL, "Insensible volume level", false);
		ppArray[4] = new ProfileProperty((getPersonalVolumeLevel()), PROP_D_PERSONAL_VOLUME_LEVEL, "Personal volume level", false);
		ppArray[5] = new ProfileProperty((getInsensibleMaxX()), PROP_D_INSENSIBLE_MAX_RESOLUTION_X, "Insensible max resolution X",false);
		ppArray[6] = new ProfileProperty((getInsensibleMaxY()), PROP_D_INSENSIBLE_MAX_RESOLUTION_Y, "Insensible max resolution Y", false);
		ppArray[7] = new ProfileProperty((getPersonalMinX()), PROP_D_PERSONAL_MIN_RESOLUTION_X, "Personal min resolution X", false);
		ppArray[8] = new ProfileProperty((getPersonalMinY()), PROP_D_PERSONAL_MIN_RESOLUTION_Y, "Personal min resolution Y", false);
