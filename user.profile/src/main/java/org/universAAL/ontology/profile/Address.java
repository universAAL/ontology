...
public class Address extends ManagedIndividual implements PropertyPublisher {
	...
	public Address(String uri, String country,
			String state, String city, String province,
			String street) {
		super(uri);
	...
	public ProfileProperty[] getStaticProperties() {
		...
		pp[0] = new ProfileProperty((getCountry() == null ? "" : getCountry()), PROP_S_COUNTRY, "Country", true);
		pp[1] = new ProfileProperty((getState() == null ? "" : getState()), PROP_S_STATE, "State", true);
		pp[2] = new ProfileProperty((getCity() == null ? "" : getCity()), PROP_S_CITY, "City", true);
		pp[3] = new ProfileProperty((getProvince() == null ? "" : getProvince()), PROP_S_PROVINCE, "Province", true);
		pp[4] = new ProfileProperty((getStreet() == null ? "" : getStreet()), PROP_S_STREET, "Street", true);
