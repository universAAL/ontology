...
/**
 * Ontological enumeration of motion sensor events according to ISO 11073 - 
 ...
 * 
 * TODO: the standard says: "the tamper flag may be additionally set at any time"
 * means together with a motion-detected or motion-detected-delayed event.
 * 
 * @author Thomas Fuxreiter
 */
public class MotionSensorEvent extends ManagedIndividual {
    ...
    private static final String[] names = { "motion_detected", "motion_detected_delayed",
    	"tamper_detected", "no_condition_detected"};

    public static final MotionSensorEvent motion_detected = 
    	new MotionSensorEvent(MOTION_DETECTED);
    public static final MotionSensorEvent motion_detected_delayed = 
    	new MotionSensorEvent(MOTION_DETECTED_DELAYED);
    public static final MotionSensorEvent tamper_detected = 
    	new MotionSensorEvent(TAMPER_DETECTED);
    public static final MotionSensorEvent no_condition_detected = 
    	new MotionSensorEvent(NO_CONDITION_DETECTED);
