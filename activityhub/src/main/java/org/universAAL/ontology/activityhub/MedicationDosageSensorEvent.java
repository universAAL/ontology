...
/**
 * Ontological enumeration of medication dosage sensor events according to
 ...
 *
 */
public class MedicationDosageSensorEvent extends ManagedIndividual {
	...
	public static final MedicationDosageSensorEvent dosage_taken = 
		new MedicationDosageSensorEvent(DOSAGE_TAKEN);
	public static final MedicationDosageSensorEvent dosage_missed = 
		new MedicationDosageSensorEvent(DOSAGE_MISSED);
	public static final MedicationDosageSensorEvent no_condition_detected = 
		new MedicationDosageSensorEvent(NO_CONDITION_DETECTED);
