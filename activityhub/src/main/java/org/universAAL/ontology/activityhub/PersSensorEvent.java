 ...
 *
 */
public class PersSensorEvent extends ManagedIndividual {
	...
	public static final PersSensorEvent pers_activated = 
		new PersSensorEvent(PERS_ACTIVATED);
	public static final PersSensorEvent no_condition_detected = 
		new PersSensorEvent(NO_CONDITION_DETECTED);
