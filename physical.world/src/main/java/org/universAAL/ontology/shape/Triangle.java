...
public class Triangle extends Polygon {
	...
	/**
	 * Creates a triangle object. All vertices have to be in the same coordinate system
	...
	public void setVertices(Point[] verts) {
		...
		if(verts.length!=3) throw new IllegalArgumentException("Must have 3 vertices");
