...
public class RoomFunction extends ManagedIndividual {
	...
	private static final String[] names = {
        "BathRoom", "Cellar", "GuestRoom", "GuestWC", "HobbyRoom", "Kitchen", "LivingRoom", "SleepingRoom", "StorageRoom", "Studio", "WorkRoom","Wardrobe"
    };
	...
	public static ManagedIndividual getIndividualByURI(String instanceURI) {
		return (instanceURI != null
				&&  instanceURI.startsWith(Location.uAAL_LOCATION_NAMESPACE))?
						valueOf(instanceURI.substring(Location.uAAL_LOCATION_NAMESPACE.length()))
						: null;
	}
