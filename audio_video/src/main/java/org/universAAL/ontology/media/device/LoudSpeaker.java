...
public class LoudSpeaker extends Device {
	...
	static{
		...
		PROP_EFFECTIVE_POWER_IN_WATT = LOUD_SPEAKER_NAMESPACE + "effectivePowerInWatt";
	 ...
	 * URI as parameter for the case that an existing loudspeaker has to be initialized by the database for example
	 */
