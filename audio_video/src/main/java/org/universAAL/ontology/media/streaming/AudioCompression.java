...
public static final String MY_URI;
	...
	/*
	 * to add a type, following actions are necessary:
	 * add the order as public integer attribute
	 * add the name to the array of names
	 * add the internal representation of the type as public AudioCompression attribute
	 * 
	 */
	...
	public static ManagedIndividual getIndividualByURI(String instanceURI) {
		return (instanceURI != null
				&&  instanceURI.startsWith(Stream.STREAM_NAMESPACE))?
						valueOf(instanceURI.substring(Stream.STREAM_NAMESPACE.length()))
						: null;
	}
	...
	public static AudioCompression getCompressionByOrder(int order) {
        switch (order) {
        case PCM: return pcm;
        case MPEG_1_AUDIO_LAYER_3: return mpeg1AudioLayer3;
        case OGG_Vorbis: return oggVorbis;
        default: return null;
        }
	}
