...
public class VideoCamera extends Device {
	...
	PROP_PIXEL_SIZE_IN_MICRON_SQUARE = VIDEO_CAMERA_NAMESPACE
	...
	PROP_FIELD_OF_VIEW_HORIZONTAL = VIDEO_CAMERA_NAMESPACE
		+ "fieldOfViewHorizontal";
	PROP_FIELD_OF_VIEW_VERTICAL = VIDEO_CAMERA_NAMESPACE
		+ "fieldOfViewVertical";
	    ...
	    return OrderingRestriction.newOrderingRestriction(new Float(1),
		    new Float(0), true, true, Restriction
			    .getAllValuesRestrictionWithCardinality(propURI,
				    TypeMapper.getDatatypeURI(Float.class), 1,
				    0));
