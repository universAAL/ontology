...
public class InternationalSystem {
	...
	public static final Unit IND_UNIT_SI_KELVIN = new Unit("kelvin", "Kelvin", "K", MeasurableDimension.Temperature,
			IND_SI);
	public static final Unit IND_UNIT_SI_CANDELA = new Unit("candela", "Candela", "cd", MeasurableDimension.Luminance,
			IND_SI);
	public static final Unit IND_UNIT_SI_MOLE = new Unit("mole", "Mole", "mol", MeasurableDimension.SubstanceAmmount,
			IND_SI);
	// Prefixes
