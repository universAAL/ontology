...
public class Prefix extends ManagedIndividual {
    public static final String MY_URI = UnitOntology.NAMESPACE + "Prefix";
    public static final String PROP_NAME = UnitOntology.NAMESPACE + "name";
    public static final String PROP_POWER = UnitOntology.NAMESPACE + "power";
    public static final String PROP_BASE = UnitOntology.NAMESPACE + "base";
	...
	return true && hasProperty(PROP_NAME) && hasProperty(PROP_POWER)
		&& hasProperty(PROP_BASE) && hasProperty(PROP_SYMBOL);
    }
