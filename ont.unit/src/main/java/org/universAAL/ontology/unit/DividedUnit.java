...
public class DividedUnit extends DerivedUnit {
	...
	public static final String PROP_DIVIDED_BY = UnitOntology.NAMESPACE + "dividedBy";
	public static final String PROP_DIVIDED_BY_PREFIX = UnitOntology.NAMESPACE + "dividedByPrefix";
	...
	public String getSymbol() {
		if (!hasProperty(PROP_SYMBOL)) {
			...
			if (hasProperty(PROP_DIVIDED_BY_PREFIX)) {
				div = getDividedByPrefix().getSymbol() + getDividedBy().getSymbol();
			} else {
