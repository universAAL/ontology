...
public class SystemInfo extends ManagedIndividual {
	...
	public SpaceDescriptor getSpaceJoined() {
		return (SpaceDescriptor) getProperty(PROP_SPACE_JOINED);
	}

	public void setSpaceJoined(SpaceDescriptor newPropValue) {
	...
	public SpaceStatusDescriptor getSpaceChanged() {
		return (SpaceStatusDescriptor) getProperty(PROP_SPACE_CHANGED);
	}

	public void setSpaceChanged(SpaceStatusDescriptor newPropValue) {
		if (newPropValue != null)
			changeProperty(PROP_SPACE_CHANGED, newPropValue);
	}

	public SpaceDescriptor getSpaceLost() {
		return (SpaceDescriptor) getProperty(PROP_SPACE_LOST);
	}

	public void setSpaceLost(SpaceDescriptor newPropValue) {
		if (newPropValue != null)
