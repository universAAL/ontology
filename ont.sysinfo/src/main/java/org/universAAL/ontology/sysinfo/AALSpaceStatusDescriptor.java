...
/**
 * Ontological representation of AALSpaceStatusDescriptor in the sysinfo
...
public class AALSpaceStatusDescriptor extends Descriptor {
	public static final String MY_URI = SysinfoOntology.NAMESPACE + "AALSpaceStatusDescriptor";
