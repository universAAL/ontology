 ...
 */
public class SpaceDescriptor extends Descriptor {
	public static final String MY_URI = SysinfoOntology.NAMESPACE + "SpaceDescriptor";

	public SpaceDescriptor() {
		super();
	}

	public SpaceDescriptor(String uri) {
		super(uri);
	}
