 ...
 */
public class SpaceStatusDescriptor extends Descriptor {
	public static final String MY_URI = SysinfoOntology.NAMESPACE + "SpaceStatusDescriptor";

	public SpaceStatusDescriptor() {
		super();
	}

	public SpaceStatusDescriptor(String uri) {
		super(uri);
	}
