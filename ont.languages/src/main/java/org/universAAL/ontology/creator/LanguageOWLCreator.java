...
public class LanguageOWLCreator {

	private static LanguageOntology ontology = new LanguageOntology();
	...
	public static void main(String[] args) {
		...
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("Language.owl", false));
		...
		File file = new File("Language.owl");
		...
		try {
			...
			System.out.println("Saved ontology " + owlOntology + " in file Language.owl");
