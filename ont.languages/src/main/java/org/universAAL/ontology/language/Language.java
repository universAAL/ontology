...
public abstract class Language extends ManagedIndividual {
	...
	public static final String PROP_ENGLISH_LABEL = LanguageOntology.NAMESPACE + "englishLabel";
	public static final String PROP_ISO639CODE = LanguageOntology.NAMESPACE + "iso639code";
	public static final String PROP_NATIVE_LABEL = LanguageOntology.NAMESPACE + "nativeLabel";
	...
	public boolean isWellFormed() {
		return true && hasProperty(PROP_ENGLISH_LABEL) && hasProperty(PROP_ISO639CODE)
