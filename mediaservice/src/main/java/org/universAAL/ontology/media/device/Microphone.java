...
public class Microphone extends Device {
	...
	public static Restriction getClassRestrictionsOnProperty(String propURI){
		...
		if (PROP_AUDIO_COMPRESSION.equals(propURI))
			return Restriction.getAllValuesRestrictionWithCardinality(propURI, AudioCompression.MY_URI, 1, 0);
		if (PROP_POINTS_TO.equals(propURI))
			//TODO: decision needed, which object has to define the direction of a microphone
	 ...
	 * this constructor is needed for constructing microphones with an unique URI
	 */
	...
	public int getPropSerializationType(String propURI){
		if (PROP_VOLUME.equals(propURI)
				|| PROP_AMPLIFICATION.equals(propURI)
