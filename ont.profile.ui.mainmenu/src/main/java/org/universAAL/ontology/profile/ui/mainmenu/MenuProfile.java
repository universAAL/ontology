...
public class MenuProfile extends SubProfile {
	public static final String MY_URI = MenuProfileOntology.NAMESPACE + "MenuProfile";

	public static final String PROP_ENTRY = MenuProfileOntology.NAMESPACE + "hasEntry";
	...
	private void logFalseEntry(String methodName, Object o) {
		LogUtils.logError(UIMainMenuProfileActivator.context,
				MenuProfile.class, methodName, new Object[] {
						"The main menu has an entry that is not of type MenuEntry: ", o, o.getClass().getName() },
				null);
	}
