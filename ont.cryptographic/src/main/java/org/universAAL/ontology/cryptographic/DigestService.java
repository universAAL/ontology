...
public class DigestService extends CryptographicService {
	public static final String MY_URI = CryptographicOntology.NAMESPACE + "DigestService";
	public static final String PROP_RESOURCE_TO_DIGEST = CryptographicOntology.NAMESPACE + "resourceToDigest";
	public static final String PROP_DIGESTED_TEXT = CryptographicOntology.NAMESPACE + "digestedText";
	public static final String PROP_DIGEST_METHOD = CryptographicOntology.NAMESPACE + "digestMethod";
	...
	public boolean isWellFormed() {
		return super.isWellFormed() && hasProperty(PROP_RESOURCE_TO_DIGEST) && hasProperty(PROP_DIGESTED_TEXT)
