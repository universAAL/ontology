 ...
 */
public abstract class KeyExchange extends CryptographicTechnique {
	public static final String MY_URI = CryptographicOntology.NAMESPACE + "KeyExchange";

	public KeyExchange() {
		super();
	}

	public KeyExchange(String uri) {
		super(uri);
	}
