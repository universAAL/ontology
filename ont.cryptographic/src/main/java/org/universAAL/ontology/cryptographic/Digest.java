...
/**
 * Ontological representation of Digest in the cryptographic ontology. Methods
 ...
 */
public abstract class Digest extends CryptographicTechnique {
	public static final String MY_URI = CryptographicOntology.NAMESPACE + "Digest";

	public Digest() {
		super();
	}

	public Digest(String uri) {
		super(uri);
	}
