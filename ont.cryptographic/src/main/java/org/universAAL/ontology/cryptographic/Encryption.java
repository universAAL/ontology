...
public abstract class Encryption extends CryptographicTechnique {
	public static final String MY_URI = CryptographicOntology.NAMESPACE + "Encryption";
	public static final String PROP_KEY = CryptographicOntology.NAMESPACE + "key";
	...
	public EncryptionKey[] getKey() {
		...
		if (propList instanceof List)
			...
			return new EncryptionKey[] { (EncryptionKey) propList }; // Handle
																		// special
																		// case
																		// of a
																		// single
