...
public class SignAndVerifyService extends CryptographicService {
	public static final String MY_URI = CryptographicOntology.NAMESPACE + "SignAndVerifyService";
	public static final String PROP_SIGN = CryptographicOntology.NAMESPACE + "sign";
	public static final String PROP_SIGNED_RESOURCE = CryptographicOntology.NAMESPACE + "signedResource";
	public static final String PROP_ASYMMETRIC = CryptographicOntology.NAMESPACE + "asymmetric";
	public static final String PROP_KEY_RING = CryptographicOntology.NAMESPACE + "keyRing";
	public static final String PROP_VERIFICATION_RESULT = CryptographicOntology.NAMESPACE + "verificationResult";
	public static final String PROP_DIGEST = CryptographicOntology.NAMESPACE + "digest";
	...
	public boolean isWellFormed() {
		return super.isWellFormed() && hasProperty(PROP_SIGN) && hasProperty(PROP_SIGNED_RESOURCE)
				&& hasProperty(PROP_ASYMMETRIC) && hasProperty(PROP_KEY_RING) && hasProperty(PROP_VERIFICATION_RESULT)
