...
public abstract class EncryptionKey extends ManagedIndividual {
	public static final String MY_URI = CryptographicOntology.NAMESPACE + "EncryptionKey";

	public static final String PROP_KEY_LENGTH = CryptographicOntology.NAMESPACE + "keyLength";
