...
public class SignedResource extends ManagedIndividual {
	public static final String MY_URI = CryptographicOntology.NAMESPACE + "SignedResource";
	public static final String PROP_SIGNATURE = CryptographicOntology.NAMESPACE + "signature";
	...
	public boolean isWellFormed() {
		return super.isWellFormed() && hasProperty(PROP_SIGNATURE) && hasProperty(PROP_ASYMMETRIC)
				&& hasProperty(PROP_SIGNED_RESOURCE) && hasProperty(PROP_DIGEST);
	}
