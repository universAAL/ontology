...
public final class CryptographicOntology extends Ontology {
	...
	public void create() {
		...
		oci_ChainMode.toEnumeration(new ManagedIndividual[] { ChainMode.Enc, ChainMode.Dec });
		...
		oci_DigestService.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				DigestService.PROP_RESOURCE_TO_DIGEST, TypeMapper.getDatatypeURI(Resource.class), 1, 1));
		oci_DigestService.addDatatypeProperty(DigestService.PROP_DIGESTED_TEXT).setFunctional();
		oci_DigestService.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				DigestService.PROP_DIGESTED_TEXT, TypeMapper.getDatatypeURI(Base64Binary.class), 1, 1));
		...
		oci_DigestService.addRestriction(MergedRestriction
				.getAllValuesRestrictionWithCardinality(DigestService.PROP_DIGEST_METHOD, Digest.MY_URI, 1, 1));
		...
		oci_SimpleKey.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(SimpleKey.PROP_KEY_TEXT,
		...
		oci_KeyRing.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(KeyRing.PROP_PRIVATE_KEY,
		...
		oci_KeyRing.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(KeyRing.PROP_PUBLIC_KEY,
				TypeMapper.getDatatypeURI(Base64Binary.class), 0, 1));
		oci_KeyRing.addObjectProperty(KeyRing.PROP_ASYMMETRIC);
		oci_KeyRing.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(KeyRing.PROP_ASYMMETRIC,
				AsymmetricEncryption.MY_URI, 0, 1));
		...
		oci_AsymmetricEncryption.addRestriction(
				MergedRestriction.getAllValuesRestriction(AsymmetricEncryption.PROP_KEY_RING, KeyRing.MY_URI));
		...
		oci_BlockEncryption.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				BlockEncryption.PROP_BLOCK_LENGTH, TypeMapper.getDatatypeURI(Integer.class), 1, 1));
		...
		oci_MultidestinationEncryptedResource.addObjectProperty(MultidestinationEncryptedResource.PROP_DESTINATARIES)
				.setFunctional();
		oci_MultidestinationEncryptedResource.addRestriction(MergedRestriction.getAllValuesRestriction(
				MultidestinationEncryptedResource.PROP_DESTINATARIES, DestinataryEncryptedSessionKey.MY_URI));
		...
		oci_EncryptionKey.addRestriction(MergedRestriction.getAllValuesRestriction(EncryptionKey.MY_URI,
		...
		oci_ChainedBlockEncryption.addRestriction(
				MergedRestriction.getAllValuesRestriction(ChainedBlockEncryption.PROP_CHAIN_MODE, ChainMode.MY_URI));
		oci_ChainedBlockEncryption.addObjectProperty(ChainedBlockEncryption.PROP_SIMPLE).setFunctional();
		oci_ChainedBlockEncryption.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				ChainedBlockEncryption.PROP_SIMPLE, SimpleBlockEncryption.MY_URI, 1, 1));
		...
		oci_EncryptionService.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				EncryptionService.PROP_ENCRYPTED_RESOURCE, EncryptedResource.MY_URI, 1, 1));
		oci_EncryptionService.addObjectProperty(EncryptionService.PROP_ENCRYPTION).setFunctional();
		oci_EncryptionService.addRestriction(
				MergedRestriction.getAllValuesRestriction(EncryptionService.PROP_ENCRYPTION, Encryption.MY_URI));
		oci_EncryptionService.addDatatypeProperty(EncryptionService.PROP_ENCRYPTS).setFunctional();
		oci_EncryptionService.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				EncryptionService.PROP_ENCRYPTS, TypeMapper.getDatatypeURI(Resource.class), 1, 1));
		...
		oci_SignedResource.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				SignedResource.PROP_SIGNATURE, TypeMapper.getDatatypeURI(Base64Binary.class), 1, -1));
		oci_SignedResource.addObjectProperty(SignedResource.PROP_ASYMMETRIC).setFunctional();
		oci_SignedResource.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				SignedResource.PROP_ASYMMETRIC, AsymmetricEncryption.MY_URI, 1, 1));
		oci_SignedResource.addDatatypeProperty(SignedResource.PROP_SIGNED_RESOURCE).setFunctional();
		oci_SignedResource.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				SignedResource.PROP_SIGNED_RESOURCE, TypeMapper.getDatatypeURI(Resource.class), 1, 1));
		...
		oci_SignedResource.addRestriction(MergedRestriction
				.getAllValuesRestrictionWithCardinality(SignedResource.PROP_DIGEST, Digest.MY_URI, 1, 1));
		...
		oci_EncryptedResource.setResourceComment(
				"An cyphered text that when decrypted is the serialised form of a RDF resource. It also contains all the necesary information to perform the decryption process correctly.");
		...
		oci_EncryptedResource.addRestriction(MergedRestriction
				.getAllValuesRestrictionWithCardinality(EncryptedResource.PROP_ENCRYPTION, Encryption.MY_URI, 1, 1));
		oci_EncryptedResource.addDatatypeProperty(EncryptedResource.PROP_CYPHERED_TEXT).setFunctional();
		oci_EncryptedResource.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				EncryptedResource.PROP_CYPHERED_TEXT, TypeMapper.getDatatypeURI(Base64Binary.class), 1, 1));
		...
		oci_SymmetricEncryption.setResourceComment(
		...
		oci_SymmetricEncryption.addRestriction(MergedRestriction
				.getAllValuesRestrictionWithCardinality(SymmetricEncryption.PROP_SIMPLE_KEY, SimpleKey.MY_URI, 0, 1));
		...
		oci_SignAndVerifyService.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				SignAndVerifyService.PROP_SIGN, TypeMapper.getDatatypeURI(Resource.class), 1, 1));
		oci_SignAndVerifyService.addObjectProperty(SignAndVerifyService.PROP_SIGNED_RESOURCE).setFunctional();
		oci_SignAndVerifyService.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				SignAndVerifyService.PROP_SIGNED_RESOURCE, SignedResource.MY_URI, 1, -1));
		oci_SignAndVerifyService.addObjectProperty(SignAndVerifyService.PROP_ASYMMETRIC).setFunctional();
		oci_SignAndVerifyService.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				SignAndVerifyService.PROP_ASYMMETRIC, AsymmetricEncryption.MY_URI, 1, 1));
		...
		oci_SignAndVerifyService.addRestriction(MergedRestriction
				.getAllValuesRestrictionWithCardinality(SignAndVerifyService.PROP_KEY_RING, KeyRing.MY_URI, 1, -1));
		oci_SignAndVerifyService.addDatatypeProperty(SignAndVerifyService.PROP_VERIFICATION_RESULT).setFunctional();
		oci_SignAndVerifyService.addRestriction(MergedRestriction.getAllValuesRestrictionWithCardinality(
				SignAndVerifyService.PROP_VERIFICATION_RESULT, TypeMapper.getDatatypeURI(Boolean.class), 1, 1));
		oci_SignAndVerifyService.addObjectProperty(SignAndVerifyService.PROP_DIGEST).setFunctional();
		oci_SignAndVerifyService.addRestriction(MergedRestriction
				.getAllValuesRestrictionWithCardinality(SignAndVerifyService.PROP_DIGEST, Digest.MY_URI, 1, 1));
		...
		oci_Encryption
				.addRestriction(MergedRestriction.getAllValuesRestriction(Encryption.PROP_KEY, EncryptionKey.MY_URI));
		...
		MergedRestriction keylengthmr = MergedRestriction
				.getAllValuesRestrictionWithCardinality(EncryptionKey.PROP_KEY_LENGTH, possibleKeyLengths, 1, 1);
		keylengthmr.appendTo(keymr,
				new String[] { SymmetricEncryption.PROP_SIMPLE_KEY, EncryptionKey.PROP_KEY_LENGTH });
		oci_aes.addRestriction(keymr);
		// TO BE TESTED!
		// TODO use length restriction on SimpleKey.PROP_KEY_TEXT
		oci_aes.addRestriction(
				MergedRestriction.getFixedValueRestriction(BlockEncryption.PROP_BLOCK_LENGTH, new Integer(128)));
		...
		keymr = MergedRestriction.getAllValuesRestrictionWithCardinality(SymmetricEncryption.PROP_SIMPLE_KEY,
				SimpleKey.MY_URI, 0, 1);
		possibleKeyLengths = new IntRestriction(32, true, 448, true);
		keylengthmr = MergedRestriction.getAllValuesRestrictionWithCardinality(EncryptionKey.PROP_KEY_LENGTH,
				possibleKeyLengths, 1, 1);
		keylengthmr.appendTo(keymr,
				new String[] { SymmetricEncryption.PROP_SIMPLE_KEY, EncryptionKey.PROP_KEY_LENGTH });
		oci_blowfish.addRestriction(keymr);
		// TODO use length restriction on SimpleKey.PROP_KEY_TEXT
		oci_blowfish.addRestriction(
				MergedRestriction.getFixedValueRestriction(BlockEncryption.PROP_BLOCK_LENGTH, new Integer(64)));
