...
public abstract class StreamEncryption extends SymmetricEncryption {
	public static final String MY_URI = CryptographicOntology.NAMESPACE + "StreamEncryption";
	public static final String PROP_INITIALIZATION_VECTOR = CryptographicOntology.NAMESPACE + "initializationVector";
