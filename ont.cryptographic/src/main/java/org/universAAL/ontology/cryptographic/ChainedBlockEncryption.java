...
public abstract class ChainedBlockEncryption extends BlockEncryption {
	public static final String MY_URI = CryptographicOntology.NAMESPACE + "ChainedBlockEncryption";
	public static final String PROP_CHAIN_MODE = CryptographicOntology.NAMESPACE + "chainMode";
	public static final String PROP_SIMPLE = CryptographicOntology.NAMESPACE + "simple";
	...
	public ChainMode[] getChainMode() {
		...
		if (propList instanceof List)
			...
			return new ChainMode[] { (ChainMode) propList }; // Handle special
																// case of a
																// single item
																// not contained
																// in a list
