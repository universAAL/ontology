...
public class ScriptEngine extends ManagedIndividual {
	...
	public static final String PROP_VERSION = AsorOntology.NAMESPACE + "version";
	public static final String PROP_NAME = AsorOntology.NAMESPACE + "name";
	public static final String PROP_MIME_TYPES = AsorOntology.NAMESPACE + "mimeTypes";
	public static final String PROP_LANGUAGE_CLASSIFIER = AsorOntology.NAMESPACE + "languageClassifier";
	public static final String PROP_FILE_EXTENSIONS = AsorOntology.NAMESPACE + "fileExtensions";
	public static final String PROP_LANGUAGE_VERSION = AsorOntology.NAMESPACE + "languageVersion";
