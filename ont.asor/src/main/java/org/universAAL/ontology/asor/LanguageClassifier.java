...
public class LanguageClassifier extends ManagedIndividual {
	public static final String MY_URI = AsorOntology.NAMESPACE + "LanguageClassifier";
	public static final String PROP_SCRIPT_ENGINE = AsorOntology.NAMESPACE + "scriptEngine";
	public static final String PROP_NAME = AsorOntology.NAMESPACE + "name";

	public static final LanguageClassifier javaScript;

	static {
		javaScript = new LanguageClassifier(AsorOntology.NAMESPACE + "javaScript");
