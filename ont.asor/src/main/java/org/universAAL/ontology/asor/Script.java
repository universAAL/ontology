...
public class Script extends ManagedIndividual {
	...
	public static final String PROP_WRITTEN_IN = AsorOntology.NAMESPACE + "writtenIn";
	public static final String PROP_CONTENT = AsorOntology.NAMESPACE + "content";
	public static final String PROP_IS_RUNNING = AsorOntology.NAMESPACE + "isRunning";
	public static final String PROP_IS_PERSISTENT = AsorOntology.NAMESPACE + "isPersistent";
