...
public class DroolsReasoningOntology extends Ontology {
	...
	public void create() {
		...
		oci.addDatatypeProperty(ConsequenceProperty.PROP_HAS_KEY)
				.setFunctional();
		oci.addRestriction(MergedRestriction
				.getAllValuesRestrictionWithCardinality(
						ConsequenceProperty.PROP_HAS_KEY,
						TypeMapper.getDatatypeURI(String.class), 1, 1));
		oci.addDatatypeProperty(ConsequenceProperty.PROP_HAS_VALUE)
				.setFunctional();
		oci.addRestriction(MergedRestriction
				.getAllValuesRestrictionWithCardinality(
						ConsequenceProperty.PROP_HAS_VALUE,
						TypeMapper.getDatatypeURI(String.class), 1, 1));
		// Consequence
		...
		oci.addSuperClass(ManagedIndividual.MY_URI);
		oci.addDatatypeProperty(Consequence.PROP_HAS_IDENTIFIER)
				.setFunctional();
		oci.addRestriction(MergedRestriction
				.getAllValuesRestrictionWithCardinality(
						Consequence.PROP_HAS_IDENTIFIER,
						TypeMapper.getDatatypeURI(Long.class), 1, 1));
		oci.addObjectProperty(Consequence.PROP_HAS_PROPERTIES);
		oci.addRestriction(MergedRestriction.getAllValuesRestriction(
				Consequence.PROP_HAS_PROPERTIES, ConsequenceProperty.MY_URI));
		// FactProperty
		...
		oci.addRestriction(MergedRestriction.getAllValuesRestriction(
				Fact.PROP_HAS_PROPERTIES, FactProperty.MY_URI));
		// Rule
		...
		oci.addRestriction(MergedRestriction.getAllValuesRestriction(
				Rule.PROP_HAS_BODY, TypeMapper.getDatatypeURI(String.class)));
		...
		oci.addRestriction(MergedRestriction.getAllValuesRestriction(
				DroolsReasoning.PROP_KNOWS_FACTS, Fact.MY_URI));
		oci.addObjectProperty(DroolsReasoning.PROP_KNOWS_RULES);
		oci.addRestriction(MergedRestriction.getAllValuesRestriction(
				DroolsReasoning.PROP_KNOWS_RULES, Rule.MY_URI));
		oci.addObjectProperty(DroolsReasoning.PROP_PRODUCES_CONSEQUENCES);
		oci.addRestriction(MergedRestriction.getAllValuesRestriction(
				DroolsReasoning.PROP_PRODUCES_CONSEQUENCES, Consequence.MY_URI));
	}
