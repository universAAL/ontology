...
public class Illness extends ManagedIndividual implements PropertyPublisher {
	...
	propArray[0] = new ProfileProperty((getAnemia()), PROP_S_ANEMIA,
		"Anemia", true);
	propArray[1] = new ProfileProperty((getAllergy()), PROP_S_ALLERGY,
		"Allergy", true);
	propArray[2] = new ProfileProperty((getAsthma()), PROP_S_ASTHMA,
		"Asthma", true);
	propArray[3] = new ProfileProperty((getCancer()), PROP_S_CANCER,
		"Cancer", true);
	propArray[4] = new ProfileProperty((getCholesterol()),
		PROP_S_CHOLESTEROL, "Cholesterol", true);
	propArray[5] = new ProfileProperty((getHypertension()),
		PROP_S_HYPERTENSION, "Hypertension", true);
	propArray[6] = new ProfileProperty((getDiabetes()), PROP_S_DIABETES,
		"Diabetes", true);
	propArray[7] = new ProfileProperty((getDigestionProb()),
		PROP_S_DIGESTION_PROB, "Digestion problem", true);
	propArray[8] = new ProfileProperty((getArteriopathy()),
		PROP_S_ARTERIOPATHY, "Arteriopathy", true);
	propArray[9] = new ProfileProperty((getIschemicCardiopathy()),
		PROP_S_ISCHEMIC_CARDIOPATHY, "Cardiopathy", true);
	propArray[10] = new ProfileProperty((getDementia()), PROP_S_DEMENTIA,
		"Dementia", true);
	propArray[11] = new ProfileProperty((getMalnutrition()),
		PROP_S_MALNUTRITION, "Malnutrition", true);
	propArray[12] = new ProfileProperty((getOsteoporosis()),
		PROP_S_OSTEOPOROSIS, "Osteoporosis", true);
	propArray[13] = new ProfileProperty((getOverweiht()),
		PROP_S_OVERWEIGHT, "Overweight", true);
	propArray[14] = new ProfileProperty((getMetabolicSyndrome()),
