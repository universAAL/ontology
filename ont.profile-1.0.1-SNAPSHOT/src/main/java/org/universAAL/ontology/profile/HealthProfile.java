...
public class HealthProfile extends ManagedIndividual implements
	...
	propArray[1] = new ProfileProperty(getDoctorReference(),
		PROP_S_DOCTOR_REFERENCE, "Doctor reference", true);
	propArray[2] = new ProfileProperty(getNutrionalReference(),
		PROP_S_NUTRITIONAL_REFERENCE, "Nutritional reference", true);
	propArray[3] = new ProfileProperty(getSocialCareCenter(),
		PROP_S_SOCIAL_CARE_CENTER, "Social care center", true);
	propArray[4] = new ProfileProperty(getHospital(), PROP_S_HOSPITAL,
		"Hospital", true);
	propArray[5] = new ProfileProperty(getHeight(), PROP_S_HEIGHT,
		"Height", true);
	propArray[6] = new ProfileProperty(getAlcohol(), PROP_S_ALCOHOL,
		"Alcohol quantity", true);
	propArray[7] = new ProfileProperty(getTobacco(), PROP_S_TOBACCO,
		"Tobacco quantity", true);
	propArray[8] = new ProfileProperty(getDrugs(), PROP_S_DRUGS,
		"Drugs quantity", true);
	propArray[9] = new ProfileProperty(getWeight(),
		PROP_S_RECOMMENDED_WEIGHT, "Recommended Weight", true);
	// TODO: returns array -- find a way to handle this
	propArray[10] = new ProfileProperty(
		((getDisability() == null) ? new AccessImpairment[] { new AccessImpairment(
			LevelRating.none) }
			: getDisability()), PROP_HAS_DISABILITY, "Disability",
		true);
