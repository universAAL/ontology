...
public class MedicationDosageSensorEvent extends ActivityHubSensorEvent {
	public static final String MY_URI = ActivityHubOntology.NAMESPACE + "MedicationDosageSensorEvent";
	...
	private static final String[] names = { "dosage_taken", "dosage_missed", "no_condition_detected" };

	public static final MedicationDosageSensorEvent dosage_taken = new MedicationDosageSensorEvent(DOSAGE_TAKEN);
	public static final MedicationDosageSensorEvent dosage_missed = new MedicationDosageSensorEvent(DOSAGE_MISSED);
