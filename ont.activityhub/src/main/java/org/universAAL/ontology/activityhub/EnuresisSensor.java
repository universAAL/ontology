...
/**
 * Ontological representation of a enuresis (bed-wetting) sensor according to
...
public class EnuresisSensor extends ActivityHubSensor {
	...
	public static final String MY_URI = ActivityHubOntology.NAMESPACE + "EnuresisSensor";
