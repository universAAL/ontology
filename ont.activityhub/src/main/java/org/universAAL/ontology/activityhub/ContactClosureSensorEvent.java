...
public class ContactClosureSensorEvent extends ActivityHubSensorEvent {
    ...
    public static final ContactClosureSensorEvent contact_opened = new ContactClosureSensorEvent(
	    CONTACT_OPENED);
    public static final ContactClosureSensorEvent contact_closed = new ContactClosureSensorEvent(
	    CONTACT_CLOSED);
