...
public class UsageSensorEvent extends ActivityHubSensorEvent {
	...
	public static final String MY_URI = ActivityHubOntology.NAMESPACE + "UsageSensorEvent";
	...
	private static final String[] names = { "usage_started", "usage_ended", "expected_use_start_violation",
			"expected_use_stop_violation", "absence_violation", "no_condition_detected" };

	public static final UsageSensorEvent usage_started = new UsageSensorEvent(USAGE_STARTED);
	public static final UsageSensorEvent usage_ended = new UsageSensorEvent(USAGE_ENDED);
	...
	public static final UsageSensorEvent absence_violation = new UsageSensorEvent(ABSENCE_VIOLATION);
	public static final UsageSensorEvent no_condition_detected = new UsageSensorEvent(NO_CONDITION_DETECTED);
