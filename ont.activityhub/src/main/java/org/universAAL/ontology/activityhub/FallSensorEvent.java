...
public class FallSensorEvent extends ActivityHubSensorEvent {
	...
	private static final String[] names = { "fall_detected", "no_condition_detected" };

	public static final FallSensorEvent fall_detected = new FallSensorEvent(FALL_DETECTED);
	public static final FallSensorEvent no_condition_detected = new FallSensorEvent(NO_CONDITION_DETECTED);
