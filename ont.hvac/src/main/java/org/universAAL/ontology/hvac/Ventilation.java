...
/**
 * Class for all Ventilation systems. Where ventilation is any system that is
 * capable of moving the air in a room.
 * 
 * @author Ricardo
 */
public class Ventilation extends Hvac {
	public static final String MY_URI = HvacOntology.NAMESPACE + "Ventilation";
