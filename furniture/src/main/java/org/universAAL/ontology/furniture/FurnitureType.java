...
public class FurnitureType extends ManagedIndividual {
	...
	private static final String[] names = {
        "Chair", "Table", "Shelf", "Locker", "Sofa", "Bed", "Other"
    };
	...
	public static ManagedIndividual[] getEnumerationMembers() {
		return new ManagedIndividual[] {Chair,Table,Shelf,Locker,Sofa,Bed,Other};
	}
	...
	public static ManagedIndividual getIndividualByURI(String instanceURI) {
		return (instanceURI != null
				&&  instanceURI.startsWith(Furniture.PERSONA_FURNITURE_NAMESPACE))?
						valueOf(instanceURI.substring(Furniture.PERSONA_FURNITURE_NAMESPACE.length()))
						: null;
	}
	 ...
	 * @param name The function number. A null object is not allowed
	 */
