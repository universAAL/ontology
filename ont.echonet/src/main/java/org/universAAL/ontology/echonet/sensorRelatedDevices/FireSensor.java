...
public class FireSensor extends EchonetSuperDevice{
	...
	public static final String PROPERTY_HAS_FIRE_OCCURENCE_STATUS = EchonetOntology.NAMESPACE + "hasFireOccurenceStatus";
	public static final String PROPERTY_RESETTING_FIRE_OCCURENCE_STATUS = EchonetOntology.NAMESPACE + "resetFireOccurenceStatus";
	public FireSensor() {
		super();
	}
