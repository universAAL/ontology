...
public class FirstAidSensor extends EchonetSuperDevice{
	...
	public static final String PROPERTY_HAS_FIRST_AID_OCCURENCE_STATUS = EchonetOntology.NAMESPACE + "hasFirstAidOccurenceStatus";
	public static final String PROPERTY_RESETTING_FIRST_AID_OCCURENCE_STATUS = EchonetOntology.NAMESPACE + "resetFirstAidOccurenceStatus";
