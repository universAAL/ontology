...
public class GasLeakSensor extends EchonetSuperDevice{
	...
	public static final String PROPERTY_HAS_GAS_LEAK_OCCURENCE_STATUS = EchonetOntology.NAMESPACE + "hasGasLeakOccurenceStatus";
	public static final String PROPERTY_RESETTING_GAS_LEAK_OCCURENCE_STATUS = EchonetOntology.NAMESPACE + "resetGasLeakOccurenceStatus";
