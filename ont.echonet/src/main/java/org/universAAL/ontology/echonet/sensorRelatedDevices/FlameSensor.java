...
public class FlameSensor extends EchonetSuperDevice{
	...
	public static final String PROPERTY_HAS_FLAME_DETECTION_STATUS = EchonetOntology.NAMESPACE + "hasFlameDetectionStatus";
	public static final String PROPERTY_RESETTING_FLAME_DETECTION_STATUS = EchonetOntology.NAMESPACE + "resetFlameSensorFlameDetectionStatus";
	public FlameSensor() {
		super();
	}
