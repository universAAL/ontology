...
public class CrimePreventionSensor extends EchonetSuperDevice{
	...
	public static final String PROPERTY_HAS_INVASION_OCCURENCE_STATUS = EchonetOntology.NAMESPACE + "hasInvasionOccurenceStatus";
	public static final String PROPERTY_RESETTING_INVASION_OCCURENCE_STATUS = EchonetOntology.NAMESPACE + "resetInvasionOccurenceStatus";
