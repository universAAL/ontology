...
public class ElectricLeakSensor extends EchonetSuperDevice{
	public static final String MY_URI = EchonetOntology.NAMESPACE + "ElectricLeakSensor";
	public static final String PROPERTY_HAS_DETECTION_THRESHOLD_LEVEL = EchonetOntology.NAMESPACE + "hasDectectionThresholdLevel";
	public static final String PROPERTY_HAS_ELECTRIC_LEAK_OCCURENCE_STATUS = EchonetOntology.NAMESPACE + "hasElectricLeakOccurenceStatus";
	public static final String PROPERTY_RESETTING_ELECTRIC_LEAK_OCCURENCE_STATUS = EchonetOntology.NAMESPACE + "resetElectricLeakOccurenceStatus";
