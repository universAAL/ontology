...
public class EmergencyButton extends EchonetSuperDevice{
	...
	public static final String PROPERTY_HAS_EMERGENCY_OCCURENCE_STATUS = EchonetOntology.NAMESPACE + "hasEmergencyOccurenceStatus";
	public static final String PROPERTY_RESETTING_EMERGENCY_OCCURENCE_STATUS= EchonetOntology.NAMESPACE + "resetEmergencyOccurenceStatus";
