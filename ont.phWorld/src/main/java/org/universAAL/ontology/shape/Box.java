...
public class Box extends Shape3D {
	...
	public int getPropSerializationType(String propURI) {
		...
		if (PROP_HEIGHT.equals(propURI) || PROP_WIDTH.equals(propURI) || PROP_DEPTH.equals(propURI))
	...
	public float getDistanceTo(Shape shape) {
		...
		if (shape instanceof Box) {
			CoordinateSystem cs = CoordinateSystem.findCommonParentSystem(getCenter().getCoordinateSystem(),
					shape.getCenter().getCoordinateSystem());
	...
	public String toString() {
		return "[Center:" + getCenter().getX() + "," + getCenter().getY() + "," + getCenter().getZ() + "|Size:"
				+ getWidth() + "," + getDepth() + "," + getHeight() + "]";
	}
	...
	public boolean contains(Shape3D shape) {
		...
		if (shape instanceof Box) {
			CoordinateSystem common = CoordinateSystem.findCommonParentSystem(getLocalCoordinateSystem(),
			...
			double halfs2[] = { ((Box) shape).getWidth() / 2d, ((Box) shape).getDepth() / 2d,
