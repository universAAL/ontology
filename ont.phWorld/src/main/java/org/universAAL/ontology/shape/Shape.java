...
public abstract class Shape extends ManagedIndividual {
	...
	public Point getCenter() {
		CoordinateSystem system = (CoordinateSystem) props.get(PROP_LOCAL_COORDINATE_SYSTEM);
	...
	public int getPropSerializationType(String propURI) {
		if (PROP_POINT_REPRESENTATION.equals(propURI) || PROP_LOCAL_COORDINATE_SYSTEM.equals(propURI))
	...
	public boolean intersects(Point base, Point dir) {
		...
		try {
			throw new Exception("The method 'intersects' is disabled in this version to "
			...
			System.out.println("The method 'intersects' is disabled in this version of to "
					+ "avoid GPL libraries. If you really need this method, use the restricted GPL version, or"
					+ "modify source code of this version to include the dependencies you need:"
					+ "j3d-core and vecmath, versions at least 1.3.1.");
			e.printStackTrace();
