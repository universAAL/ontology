...
public class Ellipse extends Shape2D {
	...
	public int getPropSerializationType(String propURI) {
		...
		if (PROP_MINOR_AXIS_LENGTH.equals(propURI) || PROP_MAJOR_AXIS_LENGTH.equals(propURI))
	...
	public JgclPoint3D[] getProjectedPoints(Point point) throws JgclIndefiniteSolution {
		...
		JgclEllipse3D ellipse = new JgclEllipse3D(
				new JgclAxis2Placement3D(new JgclCartesianPoint3D(c.getX(), c.getY(), c.getZ()), null, null),
				getMinorAxisLength() / 2d, getMajorAxisLength() / 2d);
		JgclCartesianPoint3D jgclpoint = new JgclCartesianPoint3D(p.getX(), p.getY(), p.getZ());
