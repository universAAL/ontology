...
public class Address extends ManagedIndividual {
	...
	public static final String PROP_HAS_CITYQUARTER = LocationOntology.NAMESPACE + "hasAddressCityQuarter";
	public static final String PROP_HAS_CITYREGION = LocationOntology.NAMESPACE + "hasAddressCityRegion";
	public static final String PROP_HAS_CITYPLACE = LocationOntology.NAMESPACE + "hasAddressCityPlace";
	public static final String PROP_HAS_POSTALCODE = LocationOntology.NAMESPACE + "hasAddressPostalCode";
	public static final String PROP_HAS_EXTENDEDADDRESS = LocationOntology.NAMESPACE + "hasExtendedAddressDescription";
