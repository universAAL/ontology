...
public class CoordinateSystem extends ManagedIndividual {
	...
	public static final String MY_URI = LocationOntology.NAMESPACE + "CoordinateSystem";

	// private static final String[] names = {
	// "WGS84","Metric","Pixel"
	// };

	public static final CoordinateSystem WGS84 = new CoordinateSystem(LocationOntology.NAMESPACE + "WGS84");
