...
public class ElementModel<P extends Resource> {
	 ...
	 * 
	 * @param elementClass Class object of type P
	 * @param serializer serializer to be used for the classes of type P
	 * @param rootPath Absolute path to the root of the bundle-config-home (without ending "/")
	 */
