...
public class Situation extends Persistent {
	public static final String MY_URI = ReasoningOntology.NAMESPACE + "Situation";
	public static final String PROP_RDF_PREDICATE = ReasoningOntology.NAMESPACE + "rdfPredicate";
	public static final String PROP_RDF_SUBJECT = ReasoningOntology.NAMESPACE + "rdfSubject";
	public static final String PROP_RDF_OBJECT = ReasoningOntology.NAMESPACE + "rdfObject";
	...
	public boolean equals(Situation situation) {
		return situation.getRdfSubject().equals(this.getRdfSubject())
				&& (situation.getRdfObject() == this.getRdfObject()
						|| situation.getRdfObject().equals(this.getRdfObject()))
				&& (situation.getRdfPredicate() == this.getRdfPredicate()
						|| situation.getRdfPredicate().equals(this.getRdfPredicate()));
	}

	@Override
	public String toString() {
		return "<html>" + getURI() + ":<br>Subject: " + this.getRdfSubject() + "<br>Predicate: "
				+ this.getRdfPredicate() + "<br>Object: " + this.getRdfObject() + "</html>";
	}
}
