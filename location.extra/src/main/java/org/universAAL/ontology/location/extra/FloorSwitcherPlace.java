...
public class FloorSwitcherPlace extends Place {
	...
	PROP_REACHES_Z_COORDINATE = uAAL_VOCABULARY_NAMESPACE
		+ "reachesZCoordinate";
	// HAS_INCLINATION is the FloorSwitcher inclination. It is 90° for a
	// lift
     ...
     * 
     * @param uri
     *            The created FloorSwitcherPlace object URI
     * @param reachedZ
     *            Z coordinates reached by the FloorSwitcher (this array must
     ...
     * @param reachedZ
     *            A Double array with REACHES_Z_COORDINATE attributes (it must
     *            contain at least 2 elements).
     * @param name
     ...
     * of REACHES_Z_COORDINATE property. Moreover, if HAS_INCLINATION property
     * is present it must be positive.
     */
    ...
    /**
     * 
     * @return HAS_INCLINATION property value (degrees). If this property is not
     *         present it is assumed that is it 90°
     */
    ...
    /**
     * 
     * @return HAS_INCLINATION property value (radiant). If this property is not
     *         present it is assumed that is it PI/2
     */
     ...
     * 
     * @param incl
     *            FloorSwitcher inclination (degrees). This value must be
     *            positive
     */
