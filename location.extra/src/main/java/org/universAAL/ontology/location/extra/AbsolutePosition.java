...
/**
 * AbsolutePosition is a subclass of Point, because an absolute position is a
...
public class AbsolutePosition extends Point implements Position {
	...
	PROP_HAS_TRACK_MADE_GOOD = uAAL_VOCABULARY_NAMESPACE
		+ "has_track_made_good";
    ...
    /**
     * @return 2D coordinates accuracy (i.e. long/lat accuracy). If the current
     *         position has no accuracy, a null object is returned.
     * 
     */
     ...
     * 
     * @param tmg
     *            The track made good value (degrees).
     */
    ...
    /**
     * 
     * @return The current position altitude accuracy (usually is it different
     *         from 2D position accuracy)
     */
