...
public class BeamingSource extends LightSource {
	...
	static {
		...
		PROP_BEAMING_DIRECTION = LightSource.LIGHTING_NAMESPACE + "beamingDirection";
	...
	public BeamingSource(String uri, LightType type,
	...
	public int getPropSerializationType(String propURI) {
		return (PROP_BEAMING_DIRECTION.equals(propURI)
				|| PROP_TARGET_SURFACE.equals(propURI))?
						PROP_SERIALIZATION_REDUCED : super.getPropSerializationType(propURI);
	}
	
	public boolean isWellFormed() {
		return (props.containsKey(PROP_BEAMING_DIRECTION)
				|| props.containsKey(PROP_TARGET_SURFACE))
				&& super.isWellFormed();
	}
