...
/**
 * This class provides the main representation of the Orchestration ontology for
...
public final class OrchestrationOntology extends Ontology {
	...
	public void create() {
		...
		OntClassInfoSetup oci_Script = createNewOntClassInfo(Script.MY_URI,
				factory, 0);
		OntClassInfoSetup oci_Orchestrator = createNewOntClassInfo(
				Orchestrator.MY_URI, factory, 1);
		...
		oci_Orchestrator.addRestriction(MergedRestriction
				.getAllValuesRestriction(Orchestrator.PROP_SUPPORTS,
						ScriptEngine.MY_URI));
		oci_Orchestrator.addObjectProperty(Orchestrator.PROP_CONTROLS);
		oci_Orchestrator.addRestriction(MergedRestriction
				.getAllValuesRestriction(Orchestrator.PROP_CONTROLS,
						Script.MY_URI));
