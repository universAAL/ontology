...
/**
 * Ontological representation of Script in the Orchestration ontology. Methods included
...
public class Script extends ManagedIndividual {
	public static final String MY_URI = OrchestrationOntology.NAMESPACE + "Script";
	public static final String PROP_WRITTEN_IN = OrchestrationOntology.NAMESPACE + "writtenIn";
	public static final String PROP_CONTENT = OrchestrationOntology.NAMESPACE + "content";
	public static final String PROP_IS_RUNNING = OrchestrationOntology.NAMESPACE + "isRunning";
	public static final String PROP_IS_PERSISTENT = OrchestrationOntology.NAMESPACE + "isPersistent";
	public static final String PROP_NAME = OrchestrationOntology.NAMESPACE + "name";
	// public static final String PROP_RETURN_VALUE = OrchestrationOntology.NAMESPACE
	// + "returnValue";
	...
	public boolean isWellFormed() {
		return super.isWellFormed() && hasProperty(PROP_WRITTEN_IN) && hasProperty(PROP_CONTENT)
				&& hasProperty(PROP_IS_RUNNING) && hasProperty(PROP_IS_PERSISTENT) && hasProperty(PROP_NAME);
	}
