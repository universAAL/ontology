...
/**
 * Ontological representation of ScriptEngine in the Orchestration ontology. Methods
...
public class ScriptEngine extends ManagedIndividual {
	public static final String MY_URI = OrchestrationOntology.NAMESPACE + "ScriptEngine";
	public static final String PROP_VERSION = OrchestrationOntology.NAMESPACE + "version";
	public static final String PROP_NAME = OrchestrationOntology.NAMESPACE + "name";
	public static final String PROP_MIME_TYPES = OrchestrationOntology.NAMESPACE + "mimeTypes";
	public static final String PROP_LANGUAGE_CLASSIFIER = OrchestrationOntology.NAMESPACE + "languageClassifier";
	public static final String PROP_FILE_EXTENSIONS = OrchestrationOntology.NAMESPACE + "fileExtensions";
	public static final String PROP_LANGUAGE_VERSION = OrchestrationOntology.NAMESPACE + "languageVersion";
	...
	public boolean isWellFormed() {
		return super.isWellFormed() && hasProperty(PROP_VERSION) && hasProperty(PROP_NAME)
				&& hasProperty(PROP_MIME_TYPES) && hasProperty(PROP_LANGUAGE_CLASSIFIER)
				&& hasProperty(PROP_FILE_EXTENSIONS) && hasProperty(PROP_LANGUAGE_VERSION);
	}
	...
	public LanguageClassifier[] getLanguageClassifier() {
		...
		if (propList instanceof List)
			return (LanguageClassifier[]) ((List) propList).toArray(new LanguageClassifier[0]);
		else if (propList != null)
