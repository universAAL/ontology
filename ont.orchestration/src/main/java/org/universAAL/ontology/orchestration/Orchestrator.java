...
/**
 * Ontological representation of Orchestrator in the Orchestration ontology. Methods included in
...
public class Orchestrator extends Service {
	public static final String MY_URI = OrchestrationOntology.NAMESPACE + "Orchestrator";
	public static final String PROP_SUPPORTS = OrchestrationOntology.NAMESPACE + "supports";
	public static final String PROP_CONTROLS = OrchestrationOntology.NAMESPACE + "controls";

	public Orchestrator() {
		super();
	}

	public Orchestrator(String uri) {
		super(uri);
	}
