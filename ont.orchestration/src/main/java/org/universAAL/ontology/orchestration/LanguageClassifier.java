...
public class LanguageClassifier extends ManagedIndividual {
	public static final String MY_URI = OrchestrationOntology.NAMESPACE + "LanguageClassifier";
	public static final String PROP_SCRIPT_ENGINE = OrchestrationOntology.NAMESPACE + "scriptEngine";
	...
	static {
		javaScript = new LanguageClassifier(OrchestrationOntology.NAMESPACE + "javaScript");
	...
	public boolean isWellFormed() {
		return super.isWellFormed() && hasProperty(PROP_SCRIPT_ENGINE) && hasProperty(PROP_NAME);
	}
	...
	public ScriptEngine[] getScriptEngine() {
		...
		if (propList instanceof List)
			return (ScriptEngine[]) ((List) propList).toArray(new ScriptEngine[0]);
		else if (propList != null)
