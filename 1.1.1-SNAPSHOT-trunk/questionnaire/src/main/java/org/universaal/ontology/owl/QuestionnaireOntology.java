...
//import org.universaal.owl.motivation.AnsweredQuestionnaire4TreatmentStrategy;
...
public final class  QuestionnaireOntology extends Ontology {
 ...
 //-------------------------------------------------------------------------------------------  
    ...
    //load AnsweredQuestionnaire4TreatmentStrategy
    
    /*
    oci = createNewOntClassInfo(AnsweredQuestionnaire4TreatmentStrategy.MY_URI, factory, 10);
    oci.setResourceComment("An answered questionnaire for treatment strategy contains the answers given by the user in a treatment motivational strategy.");
    oci.setResourceLabel("AnsweredQuestionnaire4TreatmentStrategy");
    oci.addSuperClass(AnsweredQuestionnaire.MY_URI); 
    
    oci.addObjectProperty(AnsweredQuestionnaire4TreatmentStrategy.PROP_IS_ASSOCIATED_TO_TREATMENT).setFunctional();
    oci.addRestriction(MergedRestriction
      .getAllValuesRestrictionWithCardinality(AnsweredQuestionnaire4TreatmentStrategy.PROP_IS_ASSOCIATED_TO_TREATMENT, 
