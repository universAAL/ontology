...
public class QuestionWithMedia extends Question {
	...
	public static final String PROP_MEDIA = QuestionnaireOntology.NAMESPACE + "media";
	 ...
	 * @see Question
	 */
	public QuestionWithMedia(String qWording, Object correctAnswer, String answerType, ChoiceLabel[] choices,
			MediaObject media) {
