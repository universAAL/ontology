...
public abstract class Question extends ManagedIndividual {
	...
	public static final String MY_URI = QuestionnaireOntology.NAMESPACE + "Question";
	public static final String PROP_CORRECT_ANSWER = QuestionnaireOntology.NAMESPACE + "correcAnswer";
	public static final String PROP_HAS_CORRECT_ANSWER = QuestionnaireOntology.NAMESPACE + "hasCorrectAnswer";
	public static final String PROP_HAS_CHOICE_LABEL = QuestionnaireOntology.NAMESPACE + "hasChoiceLabel";
	public static final String PROP_ANSWER_TYPE_U_R_I = QuestionnaireOntology.NAMESPACE + "answerTypeURI";
	public static final String PROP_QUESTION_WORDING = QuestionnaireOntology.NAMESPACE + "questionWording";
	...
	public boolean isWellFormed() {
		return true && props.containsKey(PROP_CORRECT_ANSWER) && props.containsKey(PROP_HAS_CORRECT_ANSWER)
				&& props.containsKey(PROP_HAS_CHOICE_LABEL) && props.containsKey(PROP_ANSWER_TYPE_U_R_I)
