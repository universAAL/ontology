...
public class ConditionalQuestion extends Question {
	...
	public static final String MY_URI = QuestionnaireOntology.NAMESPACE + "ConditionalQuestion";
	public static final String PROP_TRIGGER_ANSWER = QuestionnaireOntology.NAMESPACE + "triggerAnswer";
	public static final String PROP_DEPENDS_ON = QuestionnaireOntology.NAMESPACE + "dependsOn";
	 ...
	 */
	public ConditionalQuestion(String qWording, Object triggerAnswer, Question dependingQuestion, String answerType,
			ChoiceLabel[] choices, Object correctAnswer) {
		this.setQuestionWording(qWording);
		this.addTriggerAnswer(triggerAnswer);
		this.setDependsOn(dependingQuestion);
		this.addAnswerTypeURI(answerType);
	...
	public boolean isWellFormed() {
		return true && props.containsKey(PROP_TRIGGER_ANSWER) && props.containsKey(PROP_DEPENDS_ON);
	}
