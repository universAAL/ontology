...
public class PartsOfDay extends ManagedIndividual {
	...
	public static final String MY_URI = QuestionnaireOntology.NAMESPACE + "PartsOfDay";
	...
	private static final String[] names = { "inTheMorning", "inTheAfternoon", "inTheEvening" };
