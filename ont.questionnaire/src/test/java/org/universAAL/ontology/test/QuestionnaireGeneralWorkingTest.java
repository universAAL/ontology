...
public class QuestionnaireGeneralWorkingTest extends OntTestCase {
	...
	protected void setUp() throws Exception {
		...
		Question q1 = questionnaire.writeASingleChoiceQuestion("Do you plan to follow the treatment?",
				TypeMapper.getDatatypeURI(Boolean.class), choices2);

		Question q2 = questionnaire.writeAConditionalQuestion("Are you sure?", Boolean.FALSE, q1,
				TypeMapper.getDatatypeURI(Boolean.class), choices2);
		Question q3 = questionnaire.writeAConditionalQuestion("Do you usually practice sport?", Boolean.TRUE, q1,
				TypeMapper.getDatatypeURI(Boolean.class), choices2);

		Question q4 = questionnaire.writeAConditionalQuestion(
				"Do you know this decission can affect the rest of your life?", Boolean.TRUE, q2,
				TypeMapper.getDatatypeURI(Boolean.class), choices2);
		Question q5 = questionnaire.writeAConditionalQuestion("Will you consider to change some health habits?",
				Boolean.FALSE, q2, TypeMapper.getDatatypeURI(Boolean.class), choices2);
		questionnaire.writeAConditionalQuestion("It has been a while since the last time you practiced sport?",
				Boolean.TRUE, q3, TypeMapper.getDatatypeURI(Boolean.class), choices2);

		questionnaire.writeAConditionalQuestion("Will you explain us why?", Boolean.TRUE, q4,
				TypeMapper.getDatatypeURI(String.class));
		questionnaire.writeAConditionalQuestion("Tell us which ones?", Boolean.TRUE, q5,
				TypeMapper.getDatatypeURI(String.class));
		questionnaire.writeAConditionalQuestion("Please, tell us why not", Boolean.FALSE, q5,
				TypeMapper.getDatatypeURI(String.class));

		questionnaire.writeASingleChoiceQuestion("When do you prefer to exercise?",
				TypeMapper.getDatatypeURI(PartsOfDay.class), choices1);
		Question q7 = questionnaire.writeASingleChoiceQuestion("Have you ever done this treatment before?",
				TypeMapper.getDatatypeURI(Boolean.class), choices2);
		questionnaire.writeAConditionalQuestion("Do you have any questions?", Boolean.TRUE, q7,
				TypeMapper.getDatatypeURI(Boolean.class), choices2);
		questionnaire.writeAMultiChoiceQuestion("When do you have to take your pills?", correctAnswers,
