...
public class QuestionnaireQuestionsTest extends OntTestCase {
	...
	@Test
	/**
	 * This test checks if the questionnaire have some specific type of
	 * questions.
	 */
	...
	@Test
	/**
	 * This test checks the getters of specific type of questions within the
	 * questionnaire.
	 */
	public void testGetSpecificTypeQuestions() {
		...
		assertTrue(cq.size() == 9 && cq.contains(q5) && cq.contains(q6) && cq.contains(q7) && cq.contains(q8)
				&& cq.contains(q9) && cq.contains(q10) && cq.contains(q11) && cq.contains(q12) && cq.contains(q13));
