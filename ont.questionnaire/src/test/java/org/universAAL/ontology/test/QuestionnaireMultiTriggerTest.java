...
public class QuestionnaireMultiTriggerTest extends OntTestCase {
	...
	protected void setUp() throws Exception {
		...
		q1 = new SingleChoiceQuestion("Is tobacco bad for health?", Boolean.TRUE,
				TypeMapper.getDatatypeURI(Boolean.class), choices2);
		q2 = new MultiChoiceQuestion("When do you have to take your pills?", correctAnswers, correctAnswersURI,
				choices1);

		q3 = new ConditionalQuestion("Are you sure?", Boolean.FALSE, q1, TypeMapper.getDatatypeURI(Boolean.class),
				choices2);
		q4 = new ConditionalQuestion("Do you smoke?", Boolean.TRUE, q1, TypeMapper.getDatatypeURI(Boolean.class),
				choices2);

		q5 = new ConditionalQuestion("Do you agree with this schedule?", correctAnswers, q2,
				TypeMapper.getDatatypeURI(Boolean.class), choices2);
	 ...
	 * correction. In this case, all the questions with correct answer has been
	 * answered properly.
	 */
	 ...
	 * not in the same order as expected. In this case, all the questions with
	 * correct answer has been answered properly.
	 */
