...
public class AVOntology extends Ontology {
	...
	public void create() {
		...
		oci.toEnumeration(new ManagedIndividual[] { AudioCompression.pcm,
				AudioCompression.mpeg1AudioLayer3, AudioCompression.oggVorbis });
		...
		oci.addRestriction(MergedRestriction
				.getAllValuesRestrictionWithCardinality(
						VideoFormat.PROP_BITS_PER_PIXEL,
						TypeMapper.getDatatypeURI(Integer.class), 1, 1));
		...
		oci.addRestriction(MergedRestriction
				.getAllValuesRestrictionWithCardinality(
						AudioFile.PROP_HAS_CONTENT_TYPE,
						TypeMapper.getDatatypeURI(String.class), 1, 1));
		...
		oci.addRestriction(MergedRestriction
				.getAllValuesRestrictionWithCardinality(
						LoudSpeaker.PROP_EFFECTIVE_POWER_IN_WATT,
						TypeMapper.getDatatypeURI(Double.class), 0, 1));
		oci.addRestriction(MergedRestriction
				.getAllValuesRestrictionWithCardinality(
						LoudSpeaker.PROP_BANDWIDTH_IN_HZ,
						TypeMapper.getDatatypeURI(Double.class), 0, 1));
		oci.addRestriction(MergedRestriction
				.getAllValuesRestrictionWithCardinality(
						LoudSpeaker.PROP_IS_MUSIC_COMPATIBLE,
						TypeMapper.getDatatypeURI(Boolean.class), 1, 1));
		oci.addRestriction(MergedRestriction
				.getAllValuesRestrictionWithCardinality(
						LoudSpeaker.PROP_UPPER_BOUND,
						TypeMapper.getDatatypeURI(Double.class), 0, 1));
		oci.addRestriction(MergedRestriction
				.getAllValuesRestrictionWithCardinality(
						LoudSpeaker.PROP_IS_MUTED,
						TypeMapper.getDatatypeURI(Boolean.class), 1, 1));
		...
		oci.addRestriction(MergedRestriction
				.getAllValuesRestrictionWithCardinality(
						VideoCamera.PROP_FRAMES_PER_SECOND,
						TypeMapper.getDatatypeURI(Integer.class), 0, 1));
