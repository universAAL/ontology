...
public class VideoCamera extends Device {
	...
	public static final String PROP_FRAMES_PER_SECOND = AVOntology.NAMESPACE + "framesPerSecond"; // also
																									// offered
																									// by
	// persona.streaming
	public static final String PROP_PIXEL_SIZE_IN_MICRON_SQUARE = AVOntology.NAMESPACE + "pixelSizeInMicronSquare";
	...
	public static final String PROP_ZOOM = AVOntology.NAMESPACE + "zoom"; // also
																			// offered
																			// by
																			// persona.streaming

	public static final String PROP_FOCAL_DISTANCE = AVOntology.NAMESPACE + "focalDistance";
	public static final String PROP_FIELD_OF_VIEW_HORIZONTAL = AVOntology.NAMESPACE + "fieldOfViewHorizontal";
	public static final String PROP_FIELD_OF_VIEW_VERTICAL = AVOntology.NAMESPACE + "fieldOfViewVertical";
	...
	public int getPropSerializationType(String propURI) {
		if (PROP_DPI.equals(propURI) || PROP_FOCUS_POINT.equals(propURI) || PROP_FRAMES_PER_SECOND.equals(propURI)
				|| PROP_PIXEL_SIZE_IN_MICRON_SQUARE.equals(propURI) || PROP_X_RESOLUTION.equals(propURI)
				|| PROP_Y_RESOLUTION.equals(propURI) || PROP_ZOOM.equals(propURI)
