...
/**
 * Delegation Form is a {@link SignedResource}, signed by the
 * {@link DelegationForm#PROP_AUTHORISER Authoriser} enabling the
 * {@link DelegationForm#PROP_DELEGATE Delegate} to perform some
 * {@link DelegationForm#PROP_DELEGATED_COMPETENCES Competences} in the form of
 * {@link Role Roles}. <BR>
 * {@link DelegationForm}s should be checked when performing Authorisation
 * queries. <BR>
 * The {@link SignedResource#PROP_SIGNED_RESOURCE} property of
 * {@link DelegationForm} should be self pointing (references the self
 * instance).
 * 
 * @author amedrano
 *
...
public class DelegationForm extends SignedResource {
	...
	public DelegationForm(String uri) {
		super(uri);
		// addDefaultAccessRight(); //TODO: how to enforce this by default
		// without breaking the Ont.create?
	}
