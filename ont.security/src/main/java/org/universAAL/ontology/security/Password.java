...
public class Password extends KnowledgeFactor {
	...
	public static final String PROP_PASSWORD = SecurityOntology.NAMESPACE + "password";
	public static final String PROP_PASSWORD_DIGEST = SecurityOntology.NAMESPACE + "passwordDigestAlgorithm";
	...
	public boolean isWellFormed() {
		return hasProperty(PROP_PASSWORD) && super.isWellFormed();
	}

	/** {@ inheritDoc} */
	public int getPropSerializationType(String propURI) {
		if (propURI.equals(PROP_PASSWORD) || propURI.equals(PROP_PASSWORD_DIGEST)) {
