...
public class Measurement extends ManagedIndividual {
  public static final String MY_URI = OwlOntology.NAMESPACE
    + "Measurement";
  public static final String PROP_HAS_ERROR = OwlOntology.NAMESPACE
    + "hasError";
  public static final String PROP_HAS_UNIT = OwlOntology.NAMESPACE
    + "hasUnit";
  public static final String PROP_HAS_PREFIX = OwlOntology.NAMESPACE
    + "hasPrefix";
  public static final String PROP_VALUE = OwlOntology.NAMESPACE
    + "value";
