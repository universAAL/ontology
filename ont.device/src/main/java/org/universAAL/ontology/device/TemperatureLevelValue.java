...
public class TemperatureLevelValue extends ManagedIndividual {
	public static final String MY_URI = DeviceOntology.NAMESPACE + "TemperatureLevelValue";
	...
	public static final TemperatureLevelValue HighTemperature = new TemperatureLevelValue(HIGH_TEMPERATURE);
	public static final TemperatureLevelValue LowTemperature = new TemperatureLevelValue(LOW_TEMPERATURE);
	public static final TemperatureLevelValue ChangeTooFast = new TemperatureLevelValue(CHANGE_TOO_FAST);
