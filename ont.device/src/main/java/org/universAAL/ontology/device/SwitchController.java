...
public class SwitchController extends SwitchActuator {
	public static final String MY_URI = DeviceOntology.NAMESPACE + "SwitchController";

	public SwitchController() {
		super();
	}

	public SwitchController(String uri) {
		super(uri);
	}
