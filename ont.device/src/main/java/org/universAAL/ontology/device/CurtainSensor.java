...
public class CurtainSensor extends Sensor {
	public static final String MY_URI = DeviceOntology.NAMESPACE + "CurtainSensor";

	public CurtainSensor() {
		super();
	}

	public CurtainSensor(String uri) {
		super(uri);
	}
