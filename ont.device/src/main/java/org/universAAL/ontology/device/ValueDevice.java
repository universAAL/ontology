...
public abstract class ValueDevice extends Device {
	public static final String MY_URI = DeviceOntology.NAMESPACE + "ValueDevice";
	public static final String PROP_HAS_VALUE = DeviceOntology.NAMESPACE + "hasValue";
	public static final String PROP_VALUE_TYPE = DeviceOntology.NAMESPACE + "valueType";
	...
	public boolean isWellFormed() {
		return true && hasProperty(PROP_HAS_VALUE) && hasProperty(PROP_VALUE_TYPE);
	}
