...
/**
 * * The MailBox class represents an address that doesn't identify a building (i.e. a post office box)
 * @author smazzei
 *
 */
public class MailBox extends Address {
	 ...
	 * @param postOfficeMailBox A string that identifies a post office mailbox
	 */
	 ...
	 * @param locality The address locality (e.g. Milan, London, etc.)
	 * @param postOfficeMailBox A string that identifies a post office mailbox.
	 * A null value or an empty string are not accepted.
	 */	
	 ...
	 * @param mailBox a null object or an empty String are not allowed
	 */
	...
	/**
	 * @return true if the Address contains at least the location property and the post office box 
	 */
