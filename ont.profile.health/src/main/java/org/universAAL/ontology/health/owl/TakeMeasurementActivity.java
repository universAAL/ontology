...
public abstract class TakeMeasurementActivity extends Treatment {
	...
	public static final String MY_URI = HealthProfileOntology.NAMESPACE + "TakeMeasurementActivity";
	...
	public TakeMeasurementActivity(AssistedPersonProfile assistedPerson, Caregiver caregiver, String tname,
	...
	public void setMeasurementRequirements(MeasurementRequirements newPropValue) {
