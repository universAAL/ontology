...
public class MeasuredPhysicalActivity extends TakeMeasurementActivity {
	public static final String MY_URI = HealthProfileOntology.NAMESPACE + "PhysicalActivity";
	public static final String PROP_HAS_ASSOCIATED_MEASUREMENT = HealthProfileOntology.NAMESPACE
	...
	public MeasuredPhysicalActivity(AssistedPersonProfile assistedPerson, Caregiver caregiver, String tname,
			String description, XMLGregorianCalendar stDt, String diseaseURI) {
		super(assistedPerson, caregiver, tname, description, stDt, diseaseURI);
	}

	public MeasuredPhysicalActivity(AssistedPersonProfile assistedPerson, Caregiver caregiver, String tname,
			TreatmentPlanning tp, String description, String diseaseURI) {
