...
public class PerformedSession extends ManagedIndividual {
	...
	public static final String MY_URI = HealthProfileOntology.NAMESPACE + "PerformedSession";
	// public static final String PROP_DATE = HealthOntology.NAMESPACE
	// + "date";
	public static final String PROP_START_TIME = HealthProfileOntology.NAMESPACE + "sessionStartTime";
	public static final String PROP_END_TIME = HealthProfileOntology.NAMESPACE + "sessionEndTime";

	public static final String PROP_IS_VALID = HealthProfileOntology.NAMESPACE + "isValid";

	public static final String PROP_HAS_ASSOCIATED_TREATMENT = HealthProfileOntology.NAMESPACE + "associatedTreatment";
	...
	public boolean isWellFormed() {
		return true
				...
				&& props.containsKey(PROP_START_TIME) && props.containsKey(PROP_END_TIME)
				&& props.containsKey(PROP_IS_VALID) && props.containsKey(PROP_HAS_ASSOCIATED_TREATMENT);
	}
