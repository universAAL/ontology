...
public class Walking extends HealthyHabitsAdoption {
    ...
    public static final String MY_URI = HealthProfileOntology.NAMESPACE + "Walking";
    ...
    public Walking(AssistedPersonProfile assistedPerson, Caregiver caregiver,
    ...
    public Walking(String tname, String description, XMLGregorianCalendar stDt,
	    String diseaseURI) {
	super(tname, description, stDt, diseaseURI);
    }

    public Walking(String tname, String description, TreatmentPlanning tp,
	    String diseaseURI) {
