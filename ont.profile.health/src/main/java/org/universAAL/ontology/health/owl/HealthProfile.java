...
public class HealthProfile extends SubProfile {
	...
	public static final String MY_URI = HealthProfileOntology.NAMESPACE + "HealthProfile";
	public static final String PROP_HAS_TREATMENT = HealthProfileOntology.NAMESPACE + "hasTreatment";
	public static final String PROP_IS_ASSIGNED_TO_AP = HealthProfileOntology.NAMESPACE + "isAssignedToAP";
	public static final String PROP_LAST_MEASUREMENTS = HealthProfileOntology.NAMESPACE + "lastMeasurements";
	public static final String PROP_BIRTH_DATE = HealthProfileOntology.NAMESPACE + "birthDate";
	public static final String PROP_GENDER = HealthProfileOntology.NAMESPACE + "gender";

	public static final String PROP_DIAGNOSED_DISEASES = HealthProfileOntology.NAMESPACE + "diseases";
