...
public abstract class HealthyHabitsAdoption extends Treatment {
	public static final String MY_URI = HealthProfileOntology.NAMESPACE + "HealthyHabitsAdoption";
	...
	public HealthyHabitsAdoption(AssistedPersonProfile assistedPerson, Caregiver caregiver, String tname,
