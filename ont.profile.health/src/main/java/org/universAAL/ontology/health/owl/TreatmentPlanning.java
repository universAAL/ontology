...
public class TreatmentPlanning extends ManagedIndividual {
	...
	public static final String MY_URI = HealthProfileOntology.NAMESPACE + "TreatmentPlanning";
	public static final String PROP_RECURRENCE = HealthProfileOntology.NAMESPACE + "recurrence";
	public static final String PROP_START_DATE = HealthProfileOntology.NAMESPACE + "startDate";
	public static final String PROP_HAS_PLANNED_SESSIONS = HealthProfileOntology.NAMESPACE + "hasSessions";
	public static final String PROP_DESCRIPTION = HealthProfileOntology.NAMESPACE + "description";
	public static final String PROP_END_DATE = HealthProfileOntology.NAMESPACE + "endDate";
	...
	public TreatmentPlanning(XMLGregorianCalendar startDate, XMLGregorianCalendar endDate, String recurrence,
			String description) {
		this.setStartDate(startDate);
		this.setEndDate(endDate);
	...
	public boolean isWellFormed() {
		return true && props.containsKey(PROP_RECURRENCE) && props.containsKey(PROP_START_DATE)
				&& props.containsKey(PROP_HAS_PLANNED_SESSIONS) && props.containsKey(PROP_DESCRIPTION)
	...
	public PlannedSession[] getPerformedSession() {
		...
		if (propList instanceof List)
			...
			return new PlannedSession[] { (PlannedSession) propList }; // Handle
		// special
		// case
		// of a
		// single
