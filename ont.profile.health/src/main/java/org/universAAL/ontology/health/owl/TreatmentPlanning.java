...
public class TreatmentPlanning extends ManagedIndividual {
    ...
    public static final String MY_URI = HealthProfileOntology.NAMESPACE
	    + "TreatmentPlanning";
    public static final String PROP_RECURRENCE = HealthProfileOntology.NAMESPACE
	    + "recurrence";
    public static final String PROP_START_DATE = HealthProfileOntology.NAMESPACE
	    + "startDate";
    public static final String PROP_HAS_PLANNED_SESSIONS = HealthProfileOntology.NAMESPACE
	    + "hasSessions";
    public static final String PROP_DESCRIPTION = HealthProfileOntology.NAMESPACE
	    + "description";
    public static final String PROP_END_DATE = HealthProfileOntology.NAMESPACE
	    + "endDate";
    ...
    public TreatmentPlanning(XMLGregorianCalendar stDt,
	    XMLGregorianCalendar endDt, String recurrence) {
	this.setStartDate(stDt);
	this.setEndDate(endDt);
    }

    public TreatmentPlanning(XMLGregorianCalendar startDate,
    ...
    public TreatmentPlanning(XMLGregorianCalendar startDate,
	    XMLGregorianCalendar endDate, String recurrence, String description) {
	this.setStartDate(startDate);
	this.setEndDate(endDate);
	...
	return true && props.containsKey(PROP_RECURRENCE)
	...
	if (propList instanceof List)
	    return (PlannedSession[]) ((List) propList)
		    .toArray(new PlannedSession[0]);
	else if (propList != null)
