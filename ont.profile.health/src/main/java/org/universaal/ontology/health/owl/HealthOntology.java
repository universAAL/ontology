...
public final class HealthOntology extends Ontology {
    ...
    public static final String PROP_PRESCRIBES_TREATMENT = HealthOntology.NAMESPACE
	    + "prescribesTreatment";
    private static final String DISEASE_PROP_DIAGNOSE_DATE = HealthOntology.NAMESPACE
	    + "diagnoseDate";
    private static final String DISEASE_PROP_DISCHARGE_DATE = HealthOntology.NAMESPACE
	    + "dischargeDate";
